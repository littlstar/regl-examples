(function e$$0(u,z,f){function c(t,A){if(!z[t]){if(!u[t]){var y="function"==typeof require&&require;if(!A&&y)return y(t,!0);if(l)return l(t,!0);y=Error("Cannot find module '"+t+"'");throw y.code="MODULE_NOT_FOUND",y;}y=z[t]={exports:{}};u[t][0].call(y.exports,function(f){var l=u[t][1][f];return c(l?l:f)},y,y.exports,e$$0,u,z,f)}return z[t].exports}for(var l="function"==typeof require&&require,E=0;E<f.length;E++)c(f[E]);return c})({1:[function(B,u,z){function f(c,f,E){return Math.sqrt(Math.pow(c,2)+
Math.pow(f,2)+Math.pow(E,2))}u.exports=function(c,l){for(var E=l.length,t=c.length,A=Array(E),y=0;y<E;++y)A[y]=[0,0,0];for(y=0;y<t;++y){var D=c[y],U=l[D[0]],x=l[D[1]],J=l[D[2]],F=U[0]-x[0],C=U[1]-x[1],u=U[2]-x[2],G=f(F,C,u),I=x[0]-J[0],z=x[1]-J[1],B=x[2]-J[2],O=f(I,z,B),L=f(J[0]-U[0],J[1]-U[1],J[2]-U[2]);1E-6>Math.min(G,O,L)||(J=.5*(G+O+L),x=Math.sqrt((J-G)*(J-O)*(J-L)/J),U=C*B-u*z,u=u*I-F*B,F=F*z-C*I,C=f(U,u,F),U/=C,u/=C,F/=C,C=A[D[0]],O=Math.atan2(x,J-O),I=u,z=F,C[0]+=O*U,C[1]+=O*I,C[2]+=O*z,O=
A[D[1]],L=Math.atan2(x,J-L),C=u,I=F,O[0]+=L*U,O[1]+=L*C,O[2]+=L*I,D=A[D[2]],G=Math.atan2(x,J-G),J=u,x=F,D[0]+=G*U,D[1]+=G*J,D[2]+=G*x)}for(y=0;y<E;++y)t=A[y],G=Math.sqrt(Math.pow(t[0],2)+Math.pow(t[1],2)+Math.pow(t[2],2)),1E-8>G?(t[0]=1,t[1]=0,t[2]=0):(t[0]/=G,t[1]/=G,t[2]/=G);return A}},{}],2:[function(B,u,z){z.positions=[[1.301895,.122622,2.550061],[1.045326,.139058,2.835156],[.569251,.155925,2.805125],[.251886,.144145,2.82928],[.063033,.131726,3.01408],[-.277753,.135892,3.10716],[-.441048,.277064,
...
1828,1826],[1832,1186,1818],[1836,13,1835],[1624,1711,1570],[778,1624,1570],[1719,1725,1721],[1002,1825,1831],[1002,1834,1825],[1834,1832,1828],[1186,21,1829],[1836,1835,22],[1837,1833,12],[1280,1830,1833],[1667,1275,1728],[16,1767,1084],[589,1765,1838],[1765,1781,1838],[1781,1737,1838],[1737,982,1838],[982,1053,1838],[1053,816,1838],[816,589,1838]]},{}],3:[function(B,u,z){u.exports=function(f){f[0]=1;f[1]=0;f[2]=0;f[3]=0;f[4]=0;f[5]=1;f[6]=0;f[7]=0;f[8]=0;f[9]=0;f[10]=1;f[11]=0;f[12]=0;f[13]=0;f[14]=
0;f[15]=1;return f}},{}],4:[function(B,u,z){var f=B("./identity");u.exports=function(c,l,E,t){var A,y,D,u,x,J,F,C,z=l[0],G=l[1];l=l[2];D=t[0];u=t[1];y=t[2];F=E[0];t=E[1];A=E[2];if(1E-6>Math.abs(z-F)&&1E-6>Math.abs(G-t)&&1E-6>Math.abs(l-A))return f(c);E=z-F;t=G-t;F=l-A;C=1/Math.sqrt(E*E+t*t+F*F);E*=C;t*=C;F*=C;A=u*F-y*t;y=y*E-D*F;D=D*t-u*E;(C=Math.sqrt(A*A+y*y+D*D))?(C=1/C,A*=C,y*=C,D*=C):D=y=A=0;u=t*D-F*y;x=F*A-E*D;J=E*y-t*A;(C=Math.sqrt(u*u+x*x+J*J))?(C=1/C,u*=C,x*=C,J*=C):J=x=u=0;c[0]=A;c[1]=u;
c[2]=E;c[3]=0;c[4]=y;c[5]=x;c[6]=t;c[7]=0;c[8]=D;c[9]=J;c[10]=F;c[11]=0;c[12]=-(A*z+y*G+D*l);c[13]=-(u*z+x*G+J*l);c[14]=-(E*z+t*G+F*l);c[15]=1;return c}},{"./identity":3}],5:[function(B,u,z){u.exports=function(f,c,l,u,t){c=1/Math.tan(c/2);var A=1/(u-t);f[0]=c/l;f[1]=0;f[2]=0;f[3]=0;f[4]=0;f[5]=c;f[6]=0;f[7]=0;f[8]=0;f[9]=0;f[10]=(t+u)*A;f[11]=-1;f[12]=0;f[13]=0;f[14]=2*t*u*A;f[15]=0;return f}},{}],6:[function(B,u,z){u.exports=function(c,l){function u(c){var f=!1;"altKey"in c&&(f=f||c.altKey!==I.alt,
I.alt=!!c.altKey);"shiftKey"in c&&(f=f||c.shiftKey!==I.shift,I.shift=!!c.shiftKey);"ctrlKey"in c&&(f=f||c.ctrlKey!==I.control,I.control=!!c.ctrlKey);"metaKey"in c&&(f=f||c.metaKey!==I.meta,I.meta=!!c.metaKey);return f}function t(c,t){var y=f.x(t),A=f.y(t);"buttons"in t&&(c=t.buttons|0);if(c!==C||y!==B||A!==G||u(t))C=c|0,B=y||0,G=A||0,l&&l(C,B,G,I)}function A(c){t(0,c)}function y(){if(C||B||G||I.shift||I.alt||I.meta||I.control)C=B=G=0,I.shift=I.alt=I.control=I.meta=!1,l&&l(0,0,0,I)}function D(c){u(c)&&
l&&l(C,B,G,I)}function z(c){0===f.buttons(c)?t(0,c):t(C,c)}function x(c){t(C|f.buttons(c),c)}function J(c){t(C&~f.buttons(c),c)}function F(){Z||(Z=!0,c.addEventListener("mousemove",z),c.addEventListener("mousedown",x),c.addEventListener("mouseup",J),c.addEventListener("mouseleave",A),c.addEventListener("mouseenter",A),c.addEventListener("mouseout",A),c.addEventListener("mouseover",A),c.addEventListener("blur",y),c.addEventListener("keyup",D),c.addEventListener("keydown",D),c.addEventListener("keypress",
D),c!==window&&(window.addEventListener("blur",y),window.addEventListener("keyup",D),window.addEventListener("keydown",D),window.addEventListener("keypress",D)))}l||(l=c,c=window);var C=0,B=0,G=0,I={shift:!1,alt:!1,control:!1,meta:!1},Z=!1;F();var ja={element:c};Object.defineProperties(ja,{enabled:{get:function(){return Z},set:function(f){f?F():Z&&(Z=!1,c.removeEventListener("mousemove",z),c.removeEventListener("mousedown",x),c.removeEventListener("mouseup",J),c.removeEventListener("mouseleave",A),
c.removeEventListener("mouseenter",A),c.removeEventListener("mouseout",A),c.removeEventListener("mouseover",A),c.removeEventListener("blur",y),c.removeEventListener("keyup",D),c.removeEventListener("keydown",D),c.removeEventListener("keypress",D),c!==window&&(window.removeEventListener("blur",y),window.removeEventListener("keyup",D),window.removeEventListener("keydown",D),window.removeEventListener("keypress",D)))},enumerable:!0},buttons:{get:function(){return C},enumerable:!0},x:{get:function(){return B},
enumerable:!0},y:{get:function(){return G},enumerable:!0},mods:{get:function(){return I},enumerable:!0}});return ja};var f=B("mouse-event")},{"mouse-event":7}],7:[function(B,u,z){function f(c){return c.target||c.srcElement||window}z.buttons=function(c){if("object"===typeof c){if("buttons"in c)return c.buttons;if("which"in c){c=c.which;if(2===c)return 4;if(3===c)return 2;if(0<c)return 1<<c-1}else if("button"in c){c=c.button;if(1===c)return 4;if(2===c)return 2;if(0<=c)return 1<<c}}return 0};z.element=
f;z.x=function(c){if("object"===typeof c){if("offsetX"in c)return c.offsetX;var l=f(c).getBoundingClientRect();return c.clientX-l.left}return 0};z.y=function(c){if("object"===typeof c){if("offsetY"in c)return c.offsetY;var l=f(c).getBoundingClientRect();return c.clientY-l.top}return 0}},{}],8:[function(B,u,z){var f=B("to-px");u.exports=function(c,l,u){"function"===typeof c&&(u=!!l,l=c,c=window);var t=f("ex",c),A=function(c){u&&c.preventDefault();var f=c.deltaX||0,A=c.deltaY||0,x=c.deltaZ||0,z=1;switch(c.deltaMode){case 1:z=
t;break;case 2:z=window.innerHeight}f*=z;A*=z;x*=z;if(f||A||x)return l(f,A,x,c)};c.addEventListener("wheel",A);return A}},{"to-px":11}],9:[function(B,u,z){u.exports=function(f,c){c||(c=[0,""]);f=String(f);var l=parseFloat(f,10);c[0]=l;c[1]=f.match(/[\d.\-\+]*\s*(.*)/)[1]||"";return c}},{}],10:[function(B,u,z){(function(f,c){"object"===typeof z&&"undefined"!==typeof u?u.exports=c():"function"===typeof define&&define.amd?define(c):f.createREGL=c()})(this,function(){function f(a){return"undefined"!==
typeof btoa?btoa(a):"base64:"+a}function c(a){a=Error("(regl) "+a);console.error(a);throw a;}function l(a,b){a||c(b)}function u(a){return a?": "+a:""}function t(a,b,d){0>b.indexOf(a)&&c("invalid value"+u(d)+". must be one of: "+b)}function A(a,b){for(a+="";a.length<b;)a=" "+a;return a}function y(){this.name="unknown";this.lines=[];this.index={};this.hasErrors=!1}function D(a,b){this.number=a;this.line=b;this.errors=[]}function z(a,b,d){this.file=a;this.line=b;this.message=d}function x(){var a=Error(),
a=(a.stack||a).toString(),b=/compileProcedure.*\n\s*at.*\((.*)\)/.exec(a);return b?b[1]:(a=/compileProcedure.*\n\s*at\s+(.*)(\n|$)/.exec(a))?a[1]:"unknown"}function B(){var a=Error(),a=(a.stack||a).toString(),b=/at REGLCommand.*\n\s+at.*\((.*)\)/.exec(a);return b?b[1]:(a=/at REGLCommand.*\n\s+at\s+(.*)\n/.exec(a))?a[1]:"unknown"}function F(a,b){var d=a.split("\n"),c=1,e=0,H={unknown:new y,0:new y};H.unknown.name=H[0].name=b||x();H.unknown.lines.push(new D(0,""));for(var wa=0;wa<d.length;++wa){var h=
d[wa],g=/^\s*\#\s*(\w+)\s+(.+)\s*$/.exec(h);if(g)switch(g[1]){case "line":if(g=/(\d+)(\s+\d+)?/.exec(g[2]))c=g[1]|0,g[2]&&(e=g[2]|0,e in H||(H[e]=new y));break;case "define":if(g=/SHADER_NAME(_B64)?\s+(.*)$/.exec(g[2]))H[e].name=g[1]?f(g[2]):g[2]}H[e].lines.push(new D(c++,h))}Object.keys(H).forEach(function(a){var b=H[a];b.lines.forEach(function(a){b.index[a.number]=a})});return H}function C(a){var b=[];a.split("\n").forEach(function(a){if(!(5>a.length)){var d=/^ERROR\:\s+(\d+)\:(\d+)\:\s*(.*)$/.exec(a);
d?b.push(new z(d[1]|0,d[2]|0,d[3].trim())):0<a.length&&b.push(new z("unknown",0,a))}});return b}function eb(a,b){b.forEach(function(b){var d=a[b.file];if(d){var c=d.index[b.line];if(c){c.errors.push(b);d.hasErrors=!0;return}}a.unknown.hasErrors=!0;a.unknown.lines[0].errors.push(b)})}function G(a){a._commandRef=x()}function I(a,b){var d=B();c(a+" in command "+(b||x())+("unknown"===d?"":" called from "+d))}function Z(a,b,d,c){typeof a!==b&&I("invalid parameter type"+u(d)+". expected "+b+", got "+typeof a,
c||x())}function ja(a,b){return 32820===a||32819===a||33635===a?2:34042===a?4:ea[a]*b}function O(a,b){this.id=Nb++;this.type=a;this.data=b}function L(a){if(0===a.length)return[];var b=a.charAt(0),d=a.charAt(a.length-1);if(1<a.length&&b===d&&('"'===b||"'"===b))return['"'+a.substr(1,a.length-2).replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];if(b=/\[(false|true|null|\d+|'[^']*'|"[^"]*")\]/.exec(a))return L(a.substr(0,b.index)).concat(L(b[1])).concat(L(a.substr(b.index+b[0].length)));b=a.split(".");if(1===
b.length)return['"'+a.replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];a=[];for(d=0;d<b.length;++d)a=a.concat(L(b[d]));return a}function fa(a){return"["+L(a).join("][")+"]"}function fb(){var a={"":0},b=[""];return{id:function(d){var c=a[d];if(c)return c;c=a[d]=b.length;b.push(d);return c},str:function(a){return b[a]}}}function Ob(a,b,d){function c(){var b=window.innerWidth,m=window.innerHeight;a!==document.body&&(m=a.getBoundingClientRect(),b=m.right-m.left,m=m.bottom-m.top);e.width=d*b;e.height=d*
m;V(e.style,{width:b+"px",height:m+"px"})}var e=document.createElement("canvas");V(e.style,{border:0,margin:0,padding:0,top:0,left:0});a.appendChild(e);a===document.body&&(e.style.position="absolute",V(a.style,{margin:0,padding:0}));window.addEventListener("resize",c,!1);c();return{canvas:e,onDestroy:function(){window.removeEventListener("resize",c);a.removeChild(e)}}}function Pb(a,b){function d(q){try{return a.getContext(q,b)}catch(c){return null}}return d("webgl")||d("experimental-webgl")||d("webgl-experimental")}
function pb(a){if("string"===typeof a)return a.split();d(Array.isArray(a),"invalid extension array");return a}function Va(a){return"string"===typeof a?(d("undefined"!==typeof document,"not supported outside of DOM"),document.querySelector(a)):a}function gb(a){var b=a||{},q,c,e,H;a={};var f=[],h=[],g="undefined"===typeof window?1:window.devicePixelRatio,r=!1,p=function(a){a&&d.raise(a)},w=function(){};"string"===typeof b?(d("undefined"!==typeof document,"selector queries only supported in DOM enviroments"),
q=document.querySelector(b),d(q,"invalid query string for element")):"object"===typeof b?"string"===typeof b.nodeName&&"function"===typeof b.appendChild&&"function"===typeof b.getBoundingClientRect?q=b:"function"===typeof b.drawArrays||"function"===typeof b.drawElements?(H=b,e=H.canvas):(d.constructor(b),"gl"in b?H=b.gl:"canvas"in b?e=Va(b.canvas):"container"in b&&(c=Va(b.container)),"attributes"in b&&(a=b.attributes,d.type(a,"object","invalid context attributes")),"extensions"in b&&(f=pb(b.extensions)),
"optionalExtensions"in b&&(h=pb(b.optionalExtensions)),"onDone"in b&&(d.type(b.onDone,"function","invalid or missing onDone callback"),p=b.onDone),"profile"in b&&(r=!!b.profile),"pixelRatio"in b&&(g=+b.pixelRatio,d(0<g,"invalid pixel ratio"))):d.raise("invalid arguments to regl");q&&("canvas"===q.nodeName.toLowerCase()?e=q:c=q);if(!H){if(!e){d("undefined"!==typeof document,"must manually specify webgl context outside of DOM environments");q=Ob(c||document.body,p,g);if(!q)return null;e=q.canvas;w=
q.onDestroy}H=Pb(e,a)}return H?{gl:H,canvas:e,container:c,extensions:f,optionalExtensions:h,pixelRatio:g,profile:r,onDone:p,onDestroy:w}:(w(),p("webgl not supported, try upgrading your browser or graphics drivers http://get.webgl.org"),null)}function Qb(a,b){function q(b){d.type(b,"string","extension name must be string");b=b.toLowerCase();var q;try{q=c[b]=a.getExtension(b)}catch(e){}return!!q}for(var c={},e=0;e<b.extensions.length;++e){var H=b.extensions[e];if(!q(H))return b.onDestroy(),b.onDone('"'+
H+'" extension is not supported by the current WebGL context, try upgrading your system or a different browser'),null}b.optionalExtensions.forEach(q);return{extensions:c,restore:function(){Object.keys(c).forEach(function(a){if(!q(a))throw Error("(regl): error restoring extension "+a);})}}}function ha(a){return!!a&&"object"===typeof a&&Array.isArray(a.shape)&&Array.isArray(a.stride)&&"number"===typeof a.offset&&a.shape.length===a.stride.length&&(Array.isArray(a.data)||Y(a.data))}function la(a,b){for(var d=
Array(a),c=0;c<a;++c)d[c]=b(c);return d}function qb(a){var b,d;b=(65535<a)<<4;a>>>=b;d=(255<a)<<3;a>>>=d;b|=d;d=(15<a)<<2;a>>>=d;b|=d;d=(3<a)<<1;return b|d|a>>>d>>1}function xa(a){a:{for(var b=16;268435456>=b;b*=16)if(a<=b){a=b;break a}a=0}b=rb[qb(a)>>2];return 0<b.length?b.pop():new ArrayBuffer(a)}function sb(a){rb[qb(a.byteLength)>>2].push(a)}function tb(a,b,d,c,e,H){for(var f=0;f<b;++f)for(var h=a[f],g=0;g<d;++g)for(var r=h[g],p=0;p<c;++p)e[H++]=r[p]}function ub(a,b,d,c,e){for(var H=1,f=d+1;f<
b.length;++f)H*=b[f];var h=b[d];if(4===b.length-d){var g=b[d+1],r=b[d+2];b=b[d+3];for(f=0;f<h;++f)tb(a[f],g,r,b,c,e),e+=H}else for(f=0;f<h;++f)ub(a[f],b,d+1,c,e),e+=H}function Wa(a){return Ra[Object.prototype.toString.call(a)]|0}function vb(a,b){for(var d=0;d<b.length;++d)a[d]=b[d]}function wb(a,d,c,m,e,f,l){for(var h=0,g=0;g<c;++g)for(var r=0;r<m;++r)a[h++]=d[e*g+f*r+l]}function Rb(a,b,c){function m(d){this.id=h++;this.buffer=a.createBuffer();this.type=d;this.usage=35044;this.byteLength=0;this.dimension=
1;this.dtype=5121;this.persistentData=null;c.profile&&(this.stats={size:0})}function e(d,b,c){d.byteLength=b.byteLength;a.bufferData(d.type,b,c)}function f(a,b,c,q,k,g){a.usage=c;if(Array.isArray(b)){if(a.dtype=q||5126,0<b.length)if(Array.isArray(b[0])){k=xb(b);for(var m=q=1;m<k.length;++m)q*=k[m];a.dimension=q;b=hb(b,k,a.dtype);e(a,b,c);g?a.persistentData=b:W.freeType(b)}else"number"===typeof b[0]?(a.dimension=k,k=W.allocType(a.dtype,b.length),vb(k,b),e(a,k,c),g?a.persistentData=k:W.freeType(k)):
Y(b[0])?(a.dimension=b[0].length,a.dtype=q||Wa(b[0])||5126,b=hb(b,[b.length,b[0].length],a.dtype),e(a,b,c),g?a.persistentData=b:W.freeType(b)):d.raise("invalid buffer data")}else if(Y(b))a.dtype=q||Wa(b),a.dimension=k,e(a,b,c),g&&(a.persistentData=new Uint8Array(new Uint8Array(b.buffer)));else if(ha(b)){k=b.shape;var na=b.stride,m=b.offset,H=0,r=0,h=0,l=0;1===k.length?(H=k[0],r=1,h=na[0],l=0):2===k.length?(H=k[0],r=k[1],h=na[0],l=na[1]):d.raise("invalid shape");a.dtype=q||Wa(b.data)||5126;a.dimension=
r;k=W.allocType(a.dtype,H*r);wb(k,b.data,H,r,h,l,m);e(a,k,c);g?a.persistentData=k:W.freeType(k)}else d.raise("invalid buffer data")}function l(c){b.bufferCount--;var q=c.buffer;d(q,"buffer must not be deleted already");a.deleteBuffer(q);c.buffer=null;delete g[c.id]}var h=0,g={};m.prototype.bind=function(){a.bindBuffer(this.type,this.buffer)};m.prototype.destroy=function(){l(this)};var r=[];c.profile&&(b.getTotalBufferSize=function(){var a=0;Object.keys(g).forEach(function(b){a+=g[b].stats.size});
return a});return{create:function(e,w,r,v){function k(b){var g=35044,e=null,m=0,w=0,h=1;Array.isArray(b)||Y(b)||ha(b)?e=b:"number"===typeof b?m=b|0:b&&(d.type(b,"object","buffer arguments must be an object, a number or an array"),"data"in b&&(d(null===e||Array.isArray(e)||Y(e)||ha(e),"invalid data for buffer"),e=b.data),"usage"in b&&(d.parameter(b.usage,Xa,"invalid buffer usage"),g=Xa[b.usage]),"type"in b&&(d.parameter(b.type,Sa,"invalid buffer type"),w=Sa[b.type]),"dimension"in b&&(d.type(b.dimension,
"number","invalid dimension"),h=b.dimension|0),"length"in b&&(d.nni(m,"buffer length must be a nonnegative integer"),m=b.length|0));K.bind();e?f(K,e,g,w,h,v):(a.bufferData(K.type,m,g),K.dtype=w||5121,K.usage=g,K.dimension=h,K.byteLength=m);c.profile&&(K.stats.size=K.byteLength*ya[K.dtype]);return k}function h(b,c){d(c+b.byteLength<=K.byteLength,"invalid buffer subdata call, buffer is too small.  Can't write data of size "+b.byteLength+" starting from offset "+c+" to a buffer of size "+K.byteLength);
a.bufferSubData(K.type,c,b)}b.bufferCount++;var K=new m(w);g[K.id]=K;r||k(e);k._reglType="buffer";k._buffer=K;k.subdata=function(a,b){var c=(b||0)|0,q;K.bind();if(Array.isArray(a)){if(0<a.length)if("number"===typeof a[0]){var e=W.allocType(K.dtype,a.length);vb(e,a);h(e,c);W.freeType(e)}else Array.isArray(a[0])||Y(a[0])?(q=xb(a),e=hb(a,q,K.dtype),h(e,c),W.freeType(e)):d.raise("invalid buffer data")}else if(Y(a))h(a,c);else if(ha(a)){q=a.shape;var g=a.stride,m=e=0,w=0,f=0;1===q.length?(e=q[0],m=1,w=
g[0],f=0):2===q.length?(e=q[0],m=q[1],w=g[0],f=g[1]):d.raise("invalid shape");q=Array.isArray(a.data)?K.dtype:Wa(a.data);q=W.allocType(q,e*m);wb(q,a.data,e,m,w,f,a.offset);h(q,c);W.freeType(q)}else d.raise("invalid data for buffer subdata");return k};c.profile&&(k.stats=K.stats);k.destroy=function(){l(K)};return k},createStream:function(a,b){var d=r.pop();d||(d=new m(a));d.bind();f(d,b,35040,0,1,!1);return d},destroyStream:function(a){r.push(a)},clear:function(){aa(g).forEach(l);r.forEach(l)},getBuffer:function(a){return a&&
a._buffer instanceof m?a._buffer:null},restore:function(){aa(g).forEach(function(b){b.buffer=a.createBuffer();a.bindBuffer(b.type,b.buffer);a.bufferData(b.type,b.persistentData||b.byteLength,b.usage)})},_initBuffer:f}}function Sb(a,b,c,m){function e(a){this.id=g++;h[this.id]=this;this.buffer=a;this.primType=4;this.type=this.vertCount=0}function f(e,g,m,k,h,r,H){e.buffer.bind();if(g){var l=H;H||Y(g)&&(!ha(g)||Y(g.data))||(l=b.oes_element_index_uint?5125:5123);c._initBuffer(e.buffer,g,m,l,3)}else a.bufferData(34963,
r,m),e.buffer.dtype=l||5121,e.buffer.usage=m,e.buffer.dimension=3,e.buffer.byteLength=r;l=H;if(!H){switch(e.buffer.dtype){case 5121:case 5120:l=5121;break;case 5123:case 5122:l=5123;break;case 5125:case 5124:l=5125;break;default:d.raise("unsupported type for element array")}e.buffer.dtype=l}e.type=l;d(5125!==l||!!b.oes_element_index_uint,"32 bit element buffers not supported, enable oes_element_index_uint first");g=h;0>g&&(g=e.buffer.byteLength,5123===l?g>>=1:5125===l&&(g>>=2));e.vertCount=g;g=k;
0>k&&(g=4,k=e.buffer.dimension,1===k&&(g=0),2===k&&(g=1),3===k&&(g=4));e.primType=g}function l(a){m.elementsCount--;d(null!==a.buffer,"must not double destroy elements");delete h[a.id];a.buffer.destroy();a.buffer=null}var h={},g=0,r={uint8:5121,uint16:5123};b.oes_element_index_uint&&(r.uint32=5125);e.prototype.bind=function(){this.buffer.bind()};var p=[];return{create:function(a,b){function g(a){if(a)if("number"===typeof a)k(a),h.primType=4,h.vertCount=a|0,h.type=5121;else{var b=null,c=35044,q=-1,
e=-1,m=0,w=0;if(Array.isArray(a)||Y(a)||ha(a))b=a;else if(d.type(a,"object","invalid arguments for elements"),"data"in a&&(b=a.data,d(Array.isArray(b)||Y(b)||ha(b),"invalid data for element buffer")),"usage"in a&&(d.parameter(a.usage,Xa,"invalid element buffer usage"),c=Xa[a.usage]),"primitive"in a&&(d.parameter(a.primitive,Ha,"invalid element buffer primitive"),q=Ha[a.primitive]),"count"in a&&(d("number"===typeof a.count&&0<=a.count,"invalid vertex count for elements"),e=a.count|0),"type"in a&&(d.parameter(a.type,
r,"invalid buffer type"),w=r[a.type]),"length"in a)m=a.length|0;else if(m=e,5123===w||5122===w)m*=2;else if(5125===w||5124===w)m*=4;f(h,b,c,q,e,m,w)}else k(),h.primType=4,h.vertCount=0,h.type=5121;return g}var k=c.create(null,34963,!0),h=new e(k._buffer);m.elementsCount++;g(a);g._reglType="elements";g._elements=h;g.subdata=function(a,b){k.subdata(a,b);return g};g.destroy=function(){l(h)};return g},createStream:function(a){var b=p.pop();b||(b=new e(c.create(null,34963,!0,!1)._buffer));f(b,a,35040,
-1,-1,0,0);return b},destroyStream:function(a){p.push(a)},getElements:function(a){return"function"===typeof a&&a._elements instanceof e?a._elements:null},clear:function(){aa(h).forEach(l)}}}function yb(a){for(var b=W.allocType(5123,a.length),d=0;d<a.length;++d)if(isNaN(a[d]))b[d]=65535;else if(Infinity===a[d])b[d]=31744;else if(-Infinity===a[d])b[d]=64512;else{zb[0]=a[d];var c=Tb[0],e=c>>>31<<15,f=(c<<1>>>24)-127,c=c>>13&1023;b[d]=-24>f?e:-14>f?e+(c+1024>>-14-f):15<f?e+31744:e+(f+15<<10)+c}return b}
function S(a){return Array.isArray(a)||Y(a)}function Ab(a){return Array.isArray(a)&&(0===a.length||"number"===typeof a[0])}function Bb(a){return Array.isArray(a)&&0!==a.length&&S(a[0])?!0:!1}function Ia(a){return Object.prototype.toString.call(a)}function jb(a){if(!a)return!1;var b=Ia(a);return 0<=Ub.indexOf(b)?!0:Ab(a)||Bb(a)||ha(a)}function Cb(a,b){36193===a.type?(a.data=yb(b),W.freeType(b)):a.data=b}function Ya(a,b,d,c,e,f){a="undefined"!==typeof M[a]?M[a]:ia[a]*Ja[b];f&&(a*=6);if(e){for(c=0;1<=
d;)c+=a*d*d,d/=2;return c}return a*d*c}function Vb(a,b,c,m,e,f,l){function h(){this.format=this.internalformat=6408;this.type=5121;this.flipY=this.premultiplyAlpha=this.compressed=!1;this.unpackAlignment=1;this.channels=this.height=this.width=this.colorSpace=0}function g(a,b){a.internalformat=b.internalformat;a.format=b.format;a.type=b.type;a.compressed=b.compressed;a.premultiplyAlpha=b.premultiplyAlpha;a.flipY=b.flipY;a.unpackAlignment=b.unpackAlignment;a.colorSpace=b.colorSpace;a.width=b.width;
a.height=b.height;a.channels=b.channels}function r(a,g){if("object"===typeof g&&g){"premultiplyAlpha"in g&&(d.type(g.premultiplyAlpha,"boolean","invalid premultiplyAlpha"),a.premultiplyAlpha=g.premultiplyAlpha);"flipY"in g&&(d.type(g.flipY,"boolean","invalid texture flip"),a.flipY=g.flipY);"alignment"in g&&(d.oneOf(g.alignment,[1,2,4,8],"invalid texture unpack alignment"),a.unpackAlignment=g.alignment);"colorSpace"in g&&(d.parameter(g.colorSpace,Db,"invalid colorSpace"),a.colorSpace=Db[g.colorSpace]);
if("type"in g){var ba=g.type;d(b.oes_texture_float||!("float"===ba||"float32"===ba),"you must enable the OES_texture_float extension in order to use floating point textures.");d(b.oes_texture_half_float||!("half float"===ba||"float16"===ba),"you must enable the OES_texture_half_float extension in order to use 16-bit floating point textures.");d(b.webgl_depth_texture||!("uint16"===ba||"uint32"===ba||"depth stencil"===ba),"you must enable the WEBGL_depth_texture extension in order to use depth/stencil textures.");
d.parameter(ba,ga,"invalid texture type");a.type=ga[ba]}var e=a.width,k=a.height,f=a.channels,ba=!1;"shape"in g?(d(Array.isArray(g.shape)&&2<=g.shape.length,"shape must be an array"),e=g.shape[0],k=g.shape[1],3===g.shape.length&&(f=g.shape[2],d(0<f&&4>=f,"invalid number of channels"),ba=!0),d(0<=e&&e<=c.maxTextureSize,"invalid width"),d(0<=k&&k<=c.maxTextureSize,"invalid height")):("radius"in g&&(e=k=g.radius,d(0<=e&&e<=c.maxTextureSize,"invalid radius")),"width"in g&&(e=g.width,d(0<=e&&e<=c.maxTextureSize,
"invalid width")),"height"in g&&(k=g.height,d(0<=k&&k<=c.maxTextureSize,"invalid height")),"channels"in g&&(f=g.channels,d(0<f&&4>=f,"invalid number of channels"),ba=!0));a.width=e|0;a.height=k|0;a.channels=f|0;e=!1;"format"in g&&(e=g.format,d(b.webgl_depth_texture||!("depth"===e||"depth stencil"===e),"you must enable the WEBGL_depth_texture extension in order to use depth/stencil textures."),d.parameter(e,T,"invalid texture format"),k=a.internalformat=T[e],a.format=lb[k],e in ga&&!("type"in g)&&
(a.type=ga[e]),e in I&&(a.compressed=!0),e=!0);!ba&&e?a.channels=ia[a.format]:ba&&!e?a.channels!==Za[a.format]&&(a.format=a.internalformat=Za[a.channels]):e&&ba&&d(a.channels===ia[a.format],"number of channels inconsistent with specified format")}}function p(b){a.pixelStorei(37440,b.flipY);a.pixelStorei(37441,b.premultiplyAlpha);a.pixelStorei(37443,b.colorSpace);a.pixelStorei(3317,b.unpackAlignment)}function w(){h.call(this);this.yOffset=this.xOffset=0;this.data=null;this.needsFree=!1;this.element=
null;this.needsCopy=!1}function Qa(a,b){var g=null;jb(b)?g=b:b&&(d.type(b,"object","invalid pixel data type"),r(a,b),"x"in b&&(a.xOffset=b.x|0),"y"in b&&(a.yOffset=b.y|0),jb(b.data)&&(g=b.data));d(!a.compressed||g instanceof Uint8Array,"compressed texture data must be stored in a uint8array");if(b.copy){d(!g,"can not specify copy and data field for the same texture");var k=e.viewportWidth,f=e.viewportHeight;a.width=a.width||k-a.xOffset;a.height=a.height||f-a.yOffset;a.needsCopy=!0;d(0<=a.xOffset&&
a.xOffset<k&&0<=a.yOffset&&a.yOffset<f&&0<a.width&&a.width<=k&&0<a.height&&a.height<=f,"copy texture read out of bounds")}else if(!g)a.width=a.width||1,a.height=a.height||1,a.channels=a.channels||4;else if(Y(g))a.channels=a.channels||4,a.data=g,"type"in b||5121!==a.type||(a.type=Ra[Object.prototype.toString.call(g)]|0);else if(Ab(g)){a.channels=a.channels||4;k=g;f=k.length;switch(a.type){case 5121:case 5123:case 5125:case 5126:f=W.allocType(a.type,f);f.set(k);a.data=f;break;case 36193:a.data=yb(k);
break;default:d.raise("unsupported texture type, must specify a typed array")}a.alignment=1;a.needsFree=!0}else if(ha(g)){k=g.data;Array.isArray(k)||5121!==a.type||(a.type=Ra[Object.prototype.toString.call(k)]|0);var f=g.shape,m=g.stride,h,l,n,ca;3===f.length?(n=f[2],ca=m[2]):(d(2===f.length,"invalid ndarray pixel data, must be 2 or 3D"),ca=n=1);h=f[0];l=f[1];f=m[0];m=m[1];a.alignment=1;a.width=h;a.height=l;a.channels=n;a.format=a.internalformat=Za[n];a.needsFree=!0;h=ca;g=g.offset;n=a.width;ca=a.height;
l=a.channels;for(var oa=W.allocType(36193===a.type?5126:a.type,n*ca*l),ta=0,Ea=0;Ea<ca;++Ea)for(var va=0;va<n;++va)for(var mb=0;mb<l;++mb)oa[ta++]=k[f*va+m*Ea+h*mb+g];Cb(a,oa)}else if("[object HTMLCanvasElement]"===Ia(g)||"[object CanvasRenderingContext2D]"===Ia(g))"[object HTMLCanvasElement]"===Ia(g)?a.element=g:a.element=g.canvas,a.width=a.element.width,a.height=a.element.height,a.channels=4;else if("[object HTMLImageElement]"===Ia(g))a.element=g,a.width=g.naturalWidth,a.height=g.naturalHeight,
a.channels=4;else if("[object HTMLVideoElement]"===Ia(g))a.element=g,a.width=g.videoWidth,a.height=g.videoHeight,a.channels=4;else if(Bb(g)){k=a.width||g[0].length;f=a.height||g.length;m=a.channels;m=S(g[0][0])?m||g[0][0].length:m||1;h=$a.shape(g);n=1;for(ca=0;ca<h.length;++ca)n*=h[ca];n=W.allocType(36193===a.type?5126:a.type,n);$a.flatten(g,h,"",n);Cb(a,n);a.alignment=1;a.width=k;a.height=f;a.channels=m;a.format=a.internalformat=Za[m];a.needsFree=!0}5126===a.type?d(0<=c.extensions.indexOf("oes_texture_float"),
"oes_texture_float extension not enabled"):36193===a.type&&d(0<=c.extensions.indexOf("oes_texture_half_float"),"oes_texture_half_float extension not enabled")}function v(b,d,c,g,e){var k=b.element,f=b.data,q=b.internalformat,n=b.format,ca=b.type,oa=b.width,ta=b.height;p(b);k?a.texSubImage2D(d,e,c,g,n,ca,k):b.compressed?a.compressedTexSubImage2D(d,e,c,g,q,oa,ta,f):b.needsCopy?(m(),a.copyTexSubImage2D(d,e,c,g,b.xOffset,b.yOffset,oa,ta)):a.texSubImage2D(d,e,c,g,oa,ta,n,ca,f)}function k(){return O.pop()||
new w}function u(a){a.needsFree&&W.freeType(a.data);w.call(a);O.push(a)}function t(){h.call(this);this.genMipmaps=!1;this.mipmapHint=4352;this.mipmask=0;this.images=Array(16)}function na(a,b,d){var c=a.images[0]=k();a.mipmask=1;c.width=a.width=b;c.height=a.height=d;c.channels=a.channels=4}function da(a,b){var c=null;if(jb(b))c=a.images[0]=k(),g(c,a),Qa(c,b),a.mipmask=1;else if(r(a,b),Array.isArray(b.mipmap))for(var e=b.mipmap,f=0;f<e.length;++f)c=a.images[f]=k(),g(c,a),c.width>>=f,c.height>>=f,Qa(c,
e[f]),a.mipmask|=1<<f;else c=a.images[0]=k(),g(c,a),Qa(c,b),a.mipmask=1;g(a,a.images[0]);(a.compressed&&33776===a.internalformat||33777===a.internalformat||33778===a.internalformat||33779===a.internalformat)&&d(0===a.width%4&&0===a.height%4,"for compressed texture formats, mipmap level 0 must have width and height that are a multiple of 4")}function A(b,d){for(var c=b.images,g=0;g<c.length&&c[g];++g){var e=c[g],k=d,f=g,q=e.element,n=e.data,ca=e.internalformat,oa=e.format,ta=e.type,Ea=e.width,va=e.height;
p(e);q?a.texImage2D(k,f,oa,oa,ta,q):e.compressed?a.compressedTexImage2D(k,f,ca,Ea,va,0,n):e.needsCopy?(m(),a.copyTexImage2D(k,f,oa,e.xOffset,e.yOffset,Ea,va,0)):a.texImage2D(k,f,oa,Ea,va,0,oa,ta,n)}}function y(){var a=fa.pop()||new t;h.call(a);for(var b=a.mipmask=0;16>b;++b)a.images[b]=null;return a}function x(a){for(var b=a.images,d=0;d<b.length;++d)b[d]&&u(b[d]),b[d]=null;fa.push(a)}function z(){this.magFilter=this.minFilter=9728;this.wrapT=this.wrapS=33071;this.anisotropic=1;this.genMipmaps=!1;
this.mipmapHint=4352}function D(a,b){if("min"in b){var g=b.min;d.parameter(g,ab);a.minFilter=ab[g];0<=Wb.indexOf(a.minFilter)&&(a.genMipmaps=!0)}"mag"in b&&(g=b.mag,d.parameter(g,Ua),a.magFilter=Ua[g]);var g=a.wrapS,e=a.wrapT;if("wrap"in b){var k=b.wrap;"string"===typeof k?(d.parameter(k,B),g=e=B[k]):Array.isArray(k)&&(d.parameter(k[0],B),d.parameter(k[1],B),g=B[k[0]],e=B[k[1]])}else"wrapS"in b&&(g=b.wrapS,d.parameter(g,B),g=B[g]),"wrapT"in b&&(e=b.wrapT,d.parameter(e,B),e=B[e]);a.wrapS=g;a.wrapT=
e;"anisotropic"in b&&(g=b.anisotropic,d("number"===typeof g&&1<=g&&g<=c.maxAnisotropic,"aniso samples must be between 1 and "),a.anisotropic=b.anisotropic);if("mipmap"in b){g=!1;switch(typeof b.mipmap){case "string":d.parameter(b.mipmap,bb,"invalid mipmap hint");a.mipmapHint=bb[b.mipmap];g=a.genMipmaps=!0;break;case "boolean":g=a.genMipmaps=b.mipmap;break;case "object":d(Array.isArray(b.mipmap),"invalid mipmap type");a.genMipmaps=!1;g=!0;break;default:d.raise("invalid mipmap type")}!g||"min"in b||
(a.minFilter=9984)}}function C(d,c){a.texParameteri(c,10241,d.minFilter);a.texParameteri(c,10240,d.magFilter);a.texParameteri(c,10242,d.wrapS);a.texParameteri(c,10243,d.wrapT);b.ext_texture_filter_anisotropic&&a.texParameteri(c,34046,d.anisotropic);d.genMipmaps&&(a.hint(33170,d.mipmapHint),a.generateMipmap(c))}function ib(b){h.call(this);this.mipmask=0;this.internalformat=6408;this.id=U++;this.refCount=1;this.target=b;this.texture=a.createTexture();this.unit=-1;this.bindCount=0;this.texInfo=new z;
l.profile&&(this.stats={size:0})}function Ka(b){a.activeTexture(33984);a.bindTexture(b.target,b.texture)}function La(){var b=L[0];b?a.bindTexture(b.target,b.texture):a.bindTexture(3553,null)}function P(b){var c=b.texture;d(c,"must not double destroy texture");var g=b.unit,e=b.target;0<=g&&(a.activeTexture(33984+g),a.bindTexture(e,null),L[g]=null);a.deleteTexture(c);b.texture=null;b.params=null;b.pixels=null;b.refCount=0;delete N[b.id];f.textureCount--}var bb={"don't care":4352,"dont care":4352,nice:4354,
fast:4353},B={repeat:10497,clamp:33071,mirror:33648},Ua={nearest:9728,linear:9729},ab=V({mipmap:9987,"nearest mipmap nearest":9984,"linear mipmap nearest":9985,"nearest mipmap linear":9986,"linear mipmap linear":9987},Ua),Db={none:0,browser:37444},ga={uint8:5121,rgba4:32819,rgb565:33635,"rgb5 a1":32820},T={alpha:6406,luminance:6409,"luminance alpha":6410,rgb:6407,rgba:6408,rgba4:32854,"rgb5 a1":32855,rgb565:36194},I={};b.ext_srgb&&(T.srgb=35904,T.srgba=35906);b.oes_texture_float&&(ga.float32=ga["float"]=
5126);b.oes_texture_half_float&&(ga.float16=ga["half float"]=36193);b.webgl_depth_texture&&(V(T,{depth:6402,"depth stencil":34041}),V(ga,{uint16:5123,uint32:5125,"depth stencil":34042}));b.webgl_compressed_texture_s3tc&&V(I,{"rgb s3tc dxt1":33776,"rgba s3tc dxt1":33777,"rgba s3tc dxt3":33778,"rgba s3tc dxt5":33779});b.webgl_compressed_texture_atc&&V(I,{"rgb atc":35986,"rgba atc explicit alpha":35987,"rgba atc interpolated alpha":34798});b.webgl_compressed_texture_pvrtc&&V(I,{"rgb pvrtc 4bppv1":35840,
"rgb pvrtc 2bppv1":35841,"rgba pvrtc 4bppv1":35842,"rgba pvrtc 2bppv1":35843});b.webgl_compressed_texture_etc1&&(I["rgb etc1"]=36196);var G=Array.prototype.slice.call(a.getParameter(34467));Object.keys(I).forEach(function(a){var b=I[a];0<=G.indexOf(b)&&(T[a]=b)});var F=Object.keys(T);c.textureFormats=F;var E=[];Object.keys(T).forEach(function(a){E[T[a]]=a});var J=[];Object.keys(ga).forEach(function(a){J[ga[a]]=a});var ra=[];Object.keys(Ua).forEach(function(a){ra[Ua[a]]=a});var Fa=[];Object.keys(ab).forEach(function(a){Fa[ab[a]]=
a});var Ga=[];Object.keys(B).forEach(function(a){Ga[B[a]]=a});var lb=F.reduce(function(a,b){var d=T[b];6409===d||6406===d||6409===d||6410===d||6402===d||34041===d?a[d]=d:32855===d||0<=b.indexOf("rgba")?a[d]=6408:a[d]=6407;return a},{}),O=[],fa=[],U=0,N={},M=c.maxTextureUnits,L=Array(M).map(function(){return null});V(ib.prototype,{bind:function(){this.bindCount+=1;var b=this.unit;if(0>b){for(var c=0;c<M;++c){var g=L[c];if(g){if(0<g.bindCount)continue;g.unit=-1}L[c]=this;b=c;break}b>=M&&d.raise("insufficient number of texture units");
l.profile&&f.maxTextureUnits<b+1&&(f.maxTextureUnits=b+1);this.unit=b;a.activeTexture(33984+b);a.bindTexture(this.target,this.texture)}return b},unbind:function(){--this.bindCount},decRef:function(){0>=--this.refCount&&P(this)}});l.profile&&(f.getTotalTextureSize=function(){var a=0;Object.keys(N).forEach(function(b){a+=N[b].stats.size});return a});return{create2D:function(b,e){function m(a,b){var e=h.texInfo;z.call(e);var k=y();"number"===typeof a?"number"===typeof b?na(k,a|0,b|0):na(k,a|0,a|0):a?
(d.type(a,"object","invalid arguments to regl.texture"),D(e,a),da(k,a)):na(k,1,1);e.genMipmaps&&(k.mipmask=(k.width<<1)-1);h.mipmask=k.mipmask;g(h,k);d.texture2D(e,k,c);h.internalformat=k.internalformat;m.width=k.width;m.height=k.height;Ka(h);A(k,3553);C(e,3553);La();x(k);l.profile&&(h.stats.size=Ya(h.internalformat,h.type,k.width,k.height,e.genMipmaps,!1));m.format=E[h.internalformat];m.type=J[h.type];m.mag=ra[e.magFilter];m.min=Fa[e.minFilter];m.wrapS=Ga[e.wrapS];m.wrapT=Ga[e.wrapT];return m}var h=
new ib(3553);N[h.id]=h;f.textureCount++;m(b,e);m.subimage=function(a,b,c,e){d(!!a,"must specify image data");b|=0;c|=0;e|=0;var n=k();g(n,h);n.width=0;n.height=0;Qa(n,a);n.width=n.width||(h.width>>e)-b;n.height=n.height||(h.height>>e)-c;d(h.type===n.type&&h.format===n.format&&h.internalformat===n.internalformat,"incompatible format for texture.subimage");d(0<=b&&0<=c&&b+n.width<=h.width&&c+n.height<=h.height,"texture.subimage write out of bounds");d(h.mipmask&1<<e,"missing mipmap data");d(n.data||
n.element||n.needsCopy,"missing image data");Ka(h);v(n,3553,b,c,e);La();u(n);return m};m.resize=function(b,d){var c=b|0,g=d|0||c;if(c===h.width&&g===h.height)return m;m.width=h.width=c;m.height=h.height=g;Ka(h);for(var n=0;h.mipmask>>n;++n)a.texImage2D(3553,n,h.format,c>>n,g>>n,0,h.format,h.type,null);La();l.profile&&(h.stats.size=Ya(h.internalformat,h.type,c,g,!1,!1));return m};m._reglType="texture2d";m._texture=h;l.profile&&(m.stats=h.stats);m.destroy=function(){h.decRef()};return m},createCube:function(b,
e,h,m,w,bb){function P(a,b,e,k,va,f){var R,Q=p.texInfo;z.call(Q);for(R=0;6>R;++R)n[R]=y();if("number"!==typeof a&&a)if("object"===typeof a)if(b)da(n[0],a),da(n[1],b),da(n[2],e),da(n[3],k),da(n[4],va),da(n[5],f);else if(D(Q,a),r(p,a),"faces"in a)for(a=a.faces,d(Array.isArray(a)&&6===a.length,"cube faces must be a length 6 array"),R=0;6>R;++R)d("object"===typeof a[R]&&!!a[R],"invalid input for cube map face"),g(n[R],p),da(n[R],a[R]);else for(R=0;6>R;++R)da(n[R],a);else d.raise("invalid arguments to cube map");
else for(a=a|0||1,R=0;6>R;++R)na(n[R],a,a);g(p,n[0]);p.mipmask=Q.genMipmaps?(n[0].width<<1)-1:n[0].mipmask;d.textureCube(p,Q,n,c);p.internalformat=n[0].internalformat;P.width=n[0].width;P.height=n[0].height;Ka(p);for(R=0;6>R;++R)A(n[R],34069+R);C(Q,34067);La();l.profile&&(p.stats.size=Ya(p.internalformat,p.type,P.width,P.height,Q.genMipmaps,!0));P.format=E[p.internalformat];P.type=J[p.type];P.mag=ra[Q.magFilter];P.min=Fa[Q.minFilter];P.wrapS=Ga[Q.wrapS];P.wrapT=Ga[Q.wrapT];for(R=0;6>R;++R)x(n[R]);
return P}var p=new ib(34067);N[p.id]=p;f.cubeCount++;var n=Array(6);P(b,e,h,m,w,bb);P.subimage=function(a,b,n,c,e){d(!!b,"must specify image data");d("number"===typeof a&&a===(a|0)&&0<=a&&6>a,"invalid face");n|=0;c|=0;e|=0;var f=k();g(f,p);f.width=0;f.height=0;Qa(f,b);f.width=f.width||(p.width>>e)-n;f.height=f.height||(p.height>>e)-c;d(p.type===f.type&&p.format===f.format&&p.internalformat===f.internalformat,"incompatible format for texture.subimage");d(0<=n&&0<=c&&n+f.width<=p.width&&c+f.height<=
p.height,"texture.subimage write out of bounds");d(p.mipmask&1<<e,"missing mipmap data");d(f.data||f.element||f.needsCopy,"missing image data");Ka(p);v(f,34069+a,n,c,e);La();u(f);return P};P.resize=function(b){b|=0;if(b!==p.width){P.width=p.width=b;P.height=p.height=b;Ka(p);for(var d=0;6>d;++d)for(var n=0;p.mipmask>>n;++n)a.texImage2D(34069+d,n,p.format,b>>n,b>>n,0,p.format,p.type,null);La();l.profile&&(p.stats.size=Ya(p.internalformat,p.type,P.width,P.height,!1,!0));return P}};P._reglType="textureCube";
P._texture=p;l.profile&&(P.stats=p.stats);P.destroy=function(){p.decRef()};return P},clear:function(){for(var b=0;b<M;++b)a.activeTexture(33984+b),a.bindTexture(3553,null),L[b]=null;aa(N).forEach(P);f.cubeCount=0;f.textureCount=0},getTexture:function(a){return null},restore:function(){aa(N).forEach(function(b){b.texture=a.createTexture();a.bindTexture(b.target,b.texture);for(var d=0;32>d;++d)if(0!==(b.mipmask&1<<d))if(3553===b.target)a.texImage2D(3553,d,b.internalformat,b.width>>d,b.height>>d,0,b.internalformat,
b.type,null);else for(var c=0;6>c;++c)a.texImage2D(34069+c,d,b.internalformat,b.width>>d,b.height>>d,0,b.internalformat,b.type,null);C(b.texInfo,b.target)})}}}function Xb(a,b,c,f,e,l){function u(a,b,d){this.target=a;this.texture=b;this.renderbuffer=d;var c=a=0;b?(a=b.width,c=b.height):d&&(a=d.width,c=d.height);this.width=a;this.height=c}function h(a){a&&(a.texture&&a.texture._texture.decRef(),a.renderbuffer&&a.renderbuffer._renderbuffer.decRef())}function g(a,b,c){if(a){if(a.texture){a=a.texture._texture;
var g=Math.max(1,a.height);d(Math.max(1,a.width)===b&&g===c,"inconsistent width/height for supplied texture")}else a=a.renderbuffer._renderbuffer,d(a.width===b&&a.height===c,"inconsistent width/height for renderbuffer");a.refCount+=1}}function r(b,d){d&&(d.texture?a.framebufferTexture2D(36160,b,d.target,d.texture._texture.texture,0):a.framebufferRenderbuffer(36160,b,36161,d.renderbuffer._renderbuffer.renderbuffer))}function p(a){var b=3553,c=null,g=null,e=a;"object"===typeof a&&(e=a.data,"target"in
a&&(b=a.target|0));d.type(e,"function","invalid attachment data");a=e._reglType;"texture2d"===a?(c=e,d(3553===b)):"textureCube"===a?(c=e,d(34069<=b&&34075>b,"invalid cube map target")):"renderbuffer"===a?(g=e,b=36161):d.raise("invalid regl object for attachment");return new u(b,c,g)}function w(a,b,d,c,g){if(d)return a=f.create2D({width:a,height:b,format:c,type:g}),a._texture.refCount=0,new u(3553,a,null);a=e.create({width:a,height:b,format:c});a._renderbuffer.refCount=0;return new u(36161,null,a)}
function t(a){return a&&(a.texture||a.renderbuffer)}function v(a,b,d){a&&(a.texture?a.texture.resize(b,d):a.renderbuffer&&a.renderbuffer.resize(b,d))}function k(){this.id=B++;C[this.id]=this;this.framebuffer=a.createFramebuffer();this.height=this.width=0;this.colorAttachments=[];this.depthStencilAttachment=this.stencilAttachment=this.depthAttachment=null}function A(a){a.colorAttachments.forEach(h);h(a.depthAttachment);h(a.stencilAttachment);h(a.depthStencilAttachment)}function K(b){var c=b.framebuffer;
d(c,"must not double destroy framebuffer");a.deleteFramebuffer(c);b.framebuffer=null;l.framebufferCount--;delete C[b.id]}function na(b){var g;a.bindFramebuffer(36160,b.framebuffer);var e=b.colorAttachments;for(g=0;g<e.length;++g)r(36064+g,e[g]);for(g=e.length;g<c.maxColorAttachments;++g)a.framebufferTexture2D(36160,36064+g,3553,null,0);a.framebufferTexture2D(36160,33306,3553,null,0);a.framebufferTexture2D(36160,36096,3553,null,0);a.framebufferTexture2D(36160,36128,3553,null,0);r(36096,b.depthAttachment);
r(36128,b.stencilAttachment);r(33306,b.depthStencilAttachment);b=a.checkFramebufferStatus(36160);36053!==b&&d.raise("framebuffer configuration not supported, status = "+Yb[b]);a.bindFramebuffer(36160,y.next);y.cur=y.next;a.getError()}function da(a,e){function f(a,e){var k;d(y.next!==h,"can not update framebuffer which is currently in use");var m=b.webgl_draw_buffers,l=0,r=0,v=!0,H=!0;k=null;var u=!0,da="rgba",K="uint8",C=1,ra=null,B=null,wa=null,I=!1;if("number"===typeof a)l=a|0,r=e|0||l;else if(a){d.type(a,
"object","invalid arguments for framebuffer");"shape"in a?(r=a.shape,d(Array.isArray(r)&&2<=r.length,"invalid shape for framebuffer"),l=r[0],r=r[1]):("radius"in a&&(l=r=a.radius),"width"in a&&(l=a.width),"height"in a&&(r=a.height));if("color"in a||"colors"in a)k=a.color||a.colors,Array.isArray(k)&&d(1===k.length||m,"multiple render targets not supported");if(!k){"colorCount"in a&&(C=a.colorCount|0,d(0<C,"invalid color buffer count"));"colorTexture"in a&&(u=!!a.colorTexture,da="rgba4");if("colorType"in
a){K=a.colorType;if(u)d(b.oes_texture_float||!("float"===K||"float32"===K),"you must enable OES_texture_float in order to use floating point framebuffer objects"),d(b.oes_texture_half_float||!("half float"===K||"float16"===K),"you must enable OES_texture_half_float in order to use 16-bit floating point framebuffer objects");else if("half float"===K||"float16"===K)d(b.ext_color_buffer_half_float,"you must enable EXT_color_buffer_half_float to use 16-bit render buffers"),da="rgba16f";else if("float"===
K||"float32"===K)d(b.webgl_color_buffer_float,"you must enable WEBGL_color_buffer_float in order to use 32-bit floating point renderbuffers"),da="rgba32f";d.oneOf(K,D,"invalid color type")}if("colorFormat"in a)if(da=a.colorFormat,0<=x.indexOf(da))u=!0;else if(0<=z.indexOf(da))u=!1;else if(u)d.oneOf(a.colorFormat,x,"invalid color format for texture");else d.oneOf(a.colorFormat,z,"invalid color format for renderbuffer")}if("depthTexture"in a||"depthStencilTexture"in a)I=!(!a.depthTexture&&!a.depthStencilTexture),
d(!I||b.webgl_depth_texture,"webgl_depth_texture extension not supported");"depth"in a&&("boolean"===typeof a.depth?v=a.depth:(ra=a.depth,H=!1));"stencil"in a&&("boolean"===typeof a.stencil?H=a.stencil:(B=a.stencil,v=!1));"depthStencil"in a&&("boolean"===typeof a.depthStencil?v=H=a.depthStencil:(wa=a.depthStencil,H=v=!1))}else l=r=1;var G=m=null,F=null,E=null;if(Array.isArray(k))m=k.map(p);else if(k)m=[p(k)];else for(m=Array(C),k=0;k<C;++k)m[k]=w(l,r,u,da,K);d(b.webgl_draw_buffers||1>=m.length,"you must enable the WEBGL_draw_buffers extension in order to use multiple color buffers.");
d(m.length<=c.maxColorAttachments,"too many color attachments, not supported");l=l||m[0].width;r=r||m[0].height;ra?G=p(ra):v&&!H&&(G=w(l,r,I,"depth","uint32"));B?F=p(B):H&&!v&&(F=w(l,r,!1,"stencil","uint8"));wa?E=p(wa):!ra&&!B&&H&&v&&(E=w(l,r,I,"depth stencil","depth stencil"));d(1>=!!ra+!!B+!!wa,"invalid framebuffer configuration, can specify exactly one depth/stencil attachment");v=null;for(k=0;k<m.length;++k)g(m[k],l,r),d(!m[k]||m[k].texture&&0<=Zb.indexOf(m[k].texture._texture.format)||m[k].renderbuffer&&
0<=$b.indexOf(m[k].renderbuffer._renderbuffer.format),"framebuffer color attachment "+k+" is invalid"),m[k]&&m[k].texture&&(H=Eb[m[k].texture._texture.format]*cb[m[k].texture._texture.type],null===v?v=H:d(v===H,"all color attachments much have the same number of bits per pixel."));g(G,l,r);d(!G||G.texture&&6402===G.texture._texture.format||G.renderbuffer&&33189===G.renderbuffer._renderbuffer.format,"invalid depth attachment for framebuffer object");g(F,l,r);d(!F||F.renderbuffer&&36168===F.renderbuffer._renderbuffer.format,
"invalid stencil attachment for framebuffer object");g(E,l,r);d(!E||E.texture&&34041===E.texture._texture.format||E.renderbuffer&&34041===E.renderbuffer._renderbuffer.format,"invalid depth-stencil attachment for framebuffer object");A(h);h.width=l;h.height=r;h.colorAttachments=m;h.depthAttachment=G;h.stencilAttachment=F;h.depthStencilAttachment=E;f.color=m.map(t);f.depth=t(G);f.stencil=t(F);f.depthStencil=t(E);f.width=h.width;f.height=h.height;na(h);return f}var h=new k;l.framebufferCount++;f(a,e);
return V(f,{resize:function(a,b){d(y.next!==h,"can not resize a framebuffer which is currently in use");var c=a|0,g=b|0||c;if(c===h.width&&g===h.height)return f;for(var e=h.colorAttachments,k=0;k<e.length;++k)v(e[k],c,g);v(h.depthAttachment,c,g);v(h.stencilAttachment,c,g);v(h.depthStencilAttachment,c,g);h.width=f.width=c;h.height=f.height=g;na(h);return f},_reglType:"framebuffer",_framebuffer:h,destroy:function(){K(h);A(h)},use:function(a){y.setFBO({framebuffer:f},a)}})}var y={cur:null,next:null,
dirty:!1,setFBO:null},x=["rgba"],z=["rgba4","rgb565","rgb5 a1"];b.ext_srgb&&z.push("srgba");b.ext_color_buffer_half_float&&z.push("rgba16f","rgb16f");b.webgl_color_buffer_float&&z.push("rgba32f");var D=["uint8"];b.oes_texture_half_float&&D.push("half float","float16");b.oes_texture_float&&D.push("float","float32");var B=0,C={};return V(y,{getFramebuffer:function(a){return"function"===typeof a&&"framebuffer"===a._reglType&&(a=a._framebuffer,a instanceof k)?a:null},create:da,createCube:function(a){function g(a){var c;
d(0>e.indexOf(y.next),"can not update framebuffer which is currently in use");var k=b.webgl_draw_buffers,h={color:null},q=0,l=null;c="rgba";var r="uint8",p=1;if("number"===typeof a)q=a|0;else if(a){d.type(a,"object","invalid arguments for framebuffer");"shape"in a?(q=a.shape,d(Array.isArray(q)&&2<=q.length,"invalid shape for framebuffer"),d(q[0]===q[1],"cube framebuffer must be square"),q=q[0]):("radius"in a&&(q=a.radius|0),"width"in a?(q=a.width|0,"height"in a&&d(a.height===q,"must be square")):
"height"in a&&(q=a.height|0));if("color"in a||"colors"in a)l=a.color||a.colors,Array.isArray(l)&&d(1===l.length||k,"multiple render targets not supported");l||("colorCount"in a&&(p=a.colorCount|0,d(0<p,"invalid color buffer count")),"colorType"in a&&(d.oneOf(a.colorType,D,"invalid color type"),r=a.colorType),"colorFormat"in a&&(c=a.colorFormat,d.oneOf(a.colorFormat,x,"invalid color format for texture")));"depth"in a&&(h.depth=a.depth);"stencil"in a&&(h.stencil=a.stencil);"depthStencil"in a&&(h.depthStencil=
a.depthStencil)}else q=1;if(l)if(Array.isArray(l))for(a=[],c=0;c<l.length;++c)a[c]=l[c];else a=[l];else for(a=Array(p),l={radius:q,format:c,type:r},c=0;c<p;++c)a[c]=f.createCube(l);h.color=Array(a.length);for(c=0;c<a.length;++c)p=a[c],d("function"===typeof p&&"textureCube"===p._reglType,"invalid cube map"),q=q||p.width,d(p.width===q&&p.height===q,"invalid cube map shape"),h.color[c]={target:34069,data:a[c]};for(c=0;6>c;++c){for(p=0;p<a.length;++p)h.color[p].target=34069+c;0<c&&(h.depth=e[0].depth,
h.stencil=e[0].stencil,h.depthStencil=e[0].depthStencil);if(e[c])e[c](h);else e[c]=da(h)}return V(g,{width:q,height:q,color:a})}var e=Array(6);g(a);return V(g,{faces:e,resize:function(a){var b=a|0;d(0<b&&b<=c.maxCubeMapSize,"invalid radius for cube fbo");if(b===g.width)return g;var k=g.color;for(a=0;a<k.length;++a)k[a].resize(b);for(a=0;6>a;++a)e[a].resize(b);g.width=g.height=b;return g},_reglType:"framebufferCube",destroy:function(){e.forEach(function(a){a.destroy()})}})},clear:function(){aa(C).forEach(K)},
restore:function(){aa(C).forEach(function(b){b.framebuffer=a.createFramebuffer();na(b)})}})}function Fb(){this.w=this.z=this.y=this.x=this.state=0;this.buffer=null;this.size=0;this.normalized=!1;this.type=5126;this.divisor=this.stride=this.offset=0}function ac(a,b,d,c,e){a=d.maxAttributes;b=Array(a);for(d=0;d<a;++d)b[d]=new Fb;return{Record:Fb,scope:{},state:b}}function bc(a,b,c,f){function e(a,b,d,c){this.name=a;this.id=b;this.location=d;this.info=c}function l(a,b){for(var d=0;d<a.length;++d)if(a[d].id===
b.id){a[d].location=b.location;return}a.push(b)}function u(c,g,e){var f=35632===c?r:p,h=f[g];if(!h){var m=b.str(g),h=a.createShader(c);a.shaderSource(h,m);a.compileShader(h);d.shaderError(a,h,m,c,e);f[g]=h}return h}function h(a,b){this.id=v++;this.fragId=a;this.vertId=b;this.program=null;this.uniforms=[];this.attributes=[];f.profile&&(this.stats={uniformsCount:0,attributesCount:0})}function g(c,g){var h,q;h=u(35632,c.fragId);q=u(35633,c.vertId);var r=c.program=a.createProgram();a.attachShader(r,h);
a.attachShader(r,q);a.linkProgram(r);d.linkError(a,r,b.str(c.fragId),b.str(c.vertId),g);var p=a.getProgramParameter(r,35718);f.profile&&(c.stats.uniformsCount=p);var w=c.uniforms;for(h=0;h<p;++h)if(q=a.getActiveUniform(r,h))if(1<q.size)for(var v=0;v<q.size;++v){var t=q.name.replace("[0]","["+v+"]");l(w,new e(t,b.id(t),a.getUniformLocation(r,t),q))}else l(w,new e(q.name,b.id(q.name),a.getUniformLocation(r,q.name),q));p=a.getProgramParameter(r,35721);f.profile&&(c.stats.attributesCount=p);w=c.attributes;
for(h=0;h<p;++h)(q=a.getActiveAttrib(r,h))&&l(w,new e(q.name,b.id(q.name),a.getAttribLocation(r,q.name),q))}var r={},p={},w={},t=[],v=0;f.profile&&(c.getMaxUniformsCount=function(){var a=0;t.forEach(function(b){b.stats.uniformsCount>a&&(a=b.stats.uniformsCount)});return a},c.getMaxAttributesCount=function(){var a=0;t.forEach(function(b){b.stats.attributesCount>a&&(a=b.stats.attributesCount)});return a});return{clear:function(){var b=a.deleteShader.bind(a);aa(r).forEach(b);r={};aa(p).forEach(b);p=
{};t.forEach(function(b){a.deleteProgram(b.program)});t.length=0;w={};c.shaderCount=0},program:function(a,b,e){d.command(0<=a,"missing vertex shader",e);d.command(0<=b,"missing fragment shader",e);var f=w[b];f||(f=w[b]={});var m=f[a];m||(m=new h(b,a),c.shaderCount++,g(m,e),f[a]=m,t.push(m));return m},restore:function(){r={};p={};for(var a=0;a<t.length;++a)g(t[a])},shader:u,frag:-1,vert:-1}}function cc(a,b,c,f,e,l){function u(g){var h;null===b.next?(d(e.preserveDrawingBuffer,'you must create a webgl context with "preserveDrawingBuffer":true in order to read pixels from the drawing buffer'),
h=5121):(d(null!==b.next.colorAttachments[0].texture,"You cannot read from a renderbuffer"),h=b.next.colorAttachments[0].texture._texture.type,l.oes_texture_float?d(5121===h||5126===h,"Reading from a framebuffer is only allowed for the types 'uint8' and 'float'"):d(5121===h,"Reading from a framebuffer is only allowed for the type 'uint8'"));var p=0,w=0,t=f.framebufferWidth,v=f.framebufferHeight,k=null;Y(g)?k=g:g&&(d.type(g,"object","invalid arguments to regl.read()"),p=g.x|0,w=g.y|0,d(0<=p&&p<f.framebufferWidth,
"invalid x offset for regl.read"),d(0<=w&&w<f.framebufferHeight,"invalid y offset for regl.read"),t=(g.width||f.framebufferWidth-p)|0,v=(g.height||f.framebufferHeight-w)|0,k=g.data||null);k&&(5121===h?d(k instanceof Uint8Array,"buffer must be 'Uint8Array' when reading from a framebuffer of type 'uint8'"):5126===h&&d(k instanceof Float32Array,"buffer must be 'Float32Array' when reading from a framebuffer of type 'float'"));d(0<t&&t+p<=f.framebufferWidth,"invalid width for read pixels");d(0<v&&v+w<=
f.framebufferHeight,"invalid height for read pixels");c();g=t*v*4;k||(5121===h?k=new Uint8Array(g):5126===h&&(k=k||new Float32Array(g)));d.isTypedArray(k,"data buffer for regl.read() must be a typedarray");d(k.byteLength>=g,"data buffer for regl.read() too small");a.pixelStorei(3333,4);a.readPixels(p,w,t,v,6408,h,k);return k}function h(a){var d;b.setFBO({framebuffer:a.framebuffer},function(){d=u(a)});return d}return function(a){return a&&"framebuffer"in a?h(a):u(a)}}function Ma(a){return Array.prototype.slice.call(a)}
function Na(a){return Ma(a).join("")}function dc(){function a(){var a=[],b=[];return V(function(){a.push.apply(a,Ma(arguments))},{def:function(){var c="v"+d++;b.push(c);0<arguments.length&&(a.push(c,"="),a.push.apply(a,Ma(arguments)),a.push(";"));return c},toString:function(){return Na([0<b.length?"var "+b+";":"",Na(a)])}})}function b(){function b(a,e){c(a,e,"=",d.def(a,e),";")}var d=a(),c=a(),e=d.toString,f=c.toString;return V(function(){d.apply(d,Ma(arguments))},{def:d.def,entry:d,exit:c,save:b,
set:function(a,c,e){b(a,c);d(a,c,"=",e,";")},toString:function(){return e()+f()}})}var d=0,c=[],e=[],f=a(),l={};return{global:f,link:function(a){for(var b=0;b<e.length;++b)if(e[b]===a)return c[b];b="g"+d++;c.push(b);e.push(a);return b},block:a,proc:function(a,d){function c(){var a="a"+e.length;e.push(a);return a}var e=[];d=d||0;for(var f=0;f<d;++f)c();var f=b(),q=f.toString;return l[a]=V(f,{arg:c,toString:function(){return Na(["function(",e.join(),"){",q(),"}"])}})},scope:b,cond:function(){var a=
Na(arguments),d=b(),c=b(),e=d.toString,f=c.toString;return V(d,{then:function(){d.apply(d,Ma(arguments));return this},"else":function(){c.apply(c,Ma(arguments));return this},toString:function(){var b=f();b&&(b="else{"+b+"}");return Na(["if(",a,"){",e(),"}",b])}})},compile:function(){var a=['"use strict";',f,"return {"];Object.keys(l).forEach(function(b){a.push('"',b,'":',l[b].toString(),",")});a.push("}");var b=Na(a).replace(/;/g,";\n").replace(/}/g,"}\n").replace(/{/g,"{\n");return Function.apply(null,
c.concat(b)).apply(null,e)}}}function db(a){return Array.isArray(a)||Y(a)||ha(a)}function Gb(a){return a.sort(function(a,d){return"viewport"===a?-1:"viewport"===d?1:a<d?-1:1})}function pa(a,b,d,c){this.thisDep=a;this.contextDep=b;this.propDep=d;this.append=c}function Ca(a){return a&&!(a.thisDep||a.contextDep||a.propDep)}function N(a){return new pa(!1,!1,!1,a)}function ma(a,b){var d=a.type;return 0===d?(d=a.data.length,new pa(!0,1<=d,2<=d,b)):4===d?(d=a.data,new pa(d.thisDep,d.contextDep,d.propDep,
b)):new pa(3===d,2===d,1===d,b)}function ec(a,b,c,f,e,l,t,h,g,r,p,w,u,v,k){function y(a){return a.replace(".","_")}function A(a,b,d){var c=y(a);ba.push(a);Ta[c]=za[c]=!!d;Aa[c]=b}function x(a,b,d){var c=y(a);ba.push(a);Array.isArray(d)?(za[c]=d.slice(),Ta[c]=d.slice()):za[c]=Ta[c]=d;Ba[c]=b}function C(){var a=dc(),c=a.link,e=a.global;a.id=Va++;a.batchId="0";var g=c(kb),f=a.shared={props:"a0"};Object.keys(kb).forEach(function(a){f[a]=e.def(g,".",a)});d.optional(function(){a.CHECK=c(d);a.commandStr=
d.guessCommand();a.command=c(a.commandStr);a.assert=function(a,b,d){a("if(!(",b,"))",this.CHECK,".commandRaise(",c(d),",",this.command,");")};ja.invalidBlendCombinations=Hb});var h=a.next={},k=a.current={};Object.keys(Ba).forEach(function(a){Array.isArray(za[a])&&(h[a]=e.def(f.next,".",a),k[a]=e.def(f.current,".",a))});var R=a.constants={};Object.keys(ja).forEach(function(a){R[a]=e.def(JSON.stringify(ja[a]))});a.invoke=function(b,d){switch(d.type){case 0:var Q=["this",f.context,f.props,a.batchId];
return b.def(c(d.data),".call(",Q.slice(0,Math.max(d.data.length+1,4)),")");case 1:return b.def(f.props,d.data);case 2:return b.def(f.context,d.data);case 3:return b.def("this",d.data);case 4:return d.data.append(a,b),d.data.ref}};a.attribCache={};var Q={};a.scopeAttrib=function(a){a=b.id(a);if(a in Q)return Q[a];var d=r.scope[a];d||(d=r.scope[a]=new X);return Q[a]=c(d)};return a}function B(a){var b=a["static"];a=a.dynamic;var d;if("profile"in b){var c=!!b.profile;d=N(function(a,b){return c});d.enable=
c}else if("profile"in a){var e=a.profile;d=ma(e,function(a,b){return a.invoke(b,e)})}return d}function z(a,b){var c=a["static"],e=a.dynamic;if("framebuffer"in c){var g=c.framebuffer;return g?(g=h.getFramebuffer(g),d.command(g,"invalid framebuffer object"),N(function(a,b){var d=a.link(g),c=a.shared;b.set(c.framebuffer,".next",d);c=c.context;b.set(c,".framebufferWidth",d+".width");b.set(c,".framebufferHeight",d+".height");return d})):N(function(a,b){var d=a.shared;b.set(d.framebuffer,".next","null");
d=d.context;b.set(d,".framebufferWidth",d+".drawingBufferWidth");b.set(d,".framebufferHeight",d+".drawingBufferHeight");return"null"})}if("framebuffer"in e){var f=e.framebuffer;return ma(f,function(a,b){var c=a.invoke(b,f),e=a.shared,n=e.framebuffer,g=b.def(n,".getFramebuffer(",c,")");d.optional(function(){a.assert(b,"!"+c+"||"+g,"invalid framebuffer object")});b.set(n,".next",g);e=e.context;b.set(e,".framebufferWidth",g+"?"+g+".width:"+e+".drawingBufferWidth");b.set(e,".framebufferHeight",g+"?"+
g+".height:"+e+".drawingBufferHeight");return g})}return null}function D(a,b,c){function e(a){if(a in g){var Q=g[a];d.commandType(Q,"object","invalid "+a,c.commandStr);var n=!0,ka=Q.x|0,h=Q.y|0,k,m;"width"in Q?(k=Q.width|0,d.command(0<=k,"invalid "+a,c.commandStr)):n=!1;"height"in Q?(m=Q.height|0,d.command(0<=m,"invalid "+a,c.commandStr)):n=!1;return new pa(!n&&b&&b.thisDep,!n&&b&&b.contextDep,!n&&b&&b.propDep,function(a,b){var d=a.shared.context,c=k;"width"in Q||(c=b.def(d,".","framebufferWidth",
"-",ka));var e=m;"height"in Q||(e=b.def(d,".","framebufferHeight","-",h));return[ka,h,c,e]})}if(a in f){var q=f[a],n=ma(q,function(b,c){var e=b.invoke(c,q);d.optional(function(){b.assert(c,e+"&&typeof "+e+'==="object"',"invalid "+a)});var n=b.shared.context,g=c.def(e,".x|0"),Q=c.def(e,".y|0"),f=c.def('"width" in ',e,"?",e,".width|0:","(",n,".","framebufferWidth","-",g,")"),ka=c.def('"height" in ',e,"?",e,".height|0:","(",n,".","framebufferHeight","-",Q,")");d.optional(function(){b.assert(c,f+">=0&&"+
ka+">=0","invalid "+a)});return[g,Q,f,ka]});b&&(n.thisDep=n.thisDep||b.thisDep,n.contextDep=n.contextDep||b.contextDep,n.propDep=n.propDep||b.propDep);return n}return b?new pa(b.thisDep,b.contextDep,b.propDep,function(a,b){var d=a.shared.context;return[0,0,b.def(d,".","framebufferWidth"),b.def(d,".","framebufferHeight")]}):null}var g=a["static"],f=a.dynamic;if(a=e("viewport")){var h=a;a=new pa(a.thisDep,a.contextDep,a.propDep,function(a,b){var d=h.append(a,b),c=a.shared.context;b.set(c,".viewportWidth",
d[2]);b.set(c,".viewportHeight",d[3]);return d})}return{viewport:a,scissor_box:e("scissor.box")}}function I(a){function c(a){if(a in e){var n=b.id(e[a]);d.optional(function(){p.shader(Ib[a],n,d.guessCommand())});var f=N(function(){return n});f.id=n;return f}if(a in g){var ka=g[a];return ma(ka,function(b,c){var e=b.invoke(c,ka),g=c.def(b.shared.strings,".id(",e,")");d.optional(function(){c(b.shared.shader,".shader(",Ib[a],",",g,",",b.command,");")});return g})}return null}var e=a["static"],g=a.dynamic,
f=c("frag"),h=c("vert"),k=null;Ca(f)&&Ca(h)?(k=p.program(h.id,f.id),a=N(function(a,b){return a.link(k)})):a=new pa(f&&f.thisDep||h&&h.thisDep,f&&f.contextDep||h&&h.contextDep,f&&f.propDep||h&&h.propDep,function(a,b){var c=a.shared.shader,e;e=f?f.append(a,b):b.def(c,".","frag");var g;g=h?h.append(a,b):b.def(c,".","vert");var n=c+".program("+g+","+e;d.optional(function(){n+=","+a.command});return b.def(n+")")});return{frag:f,vert:h,progVar:a,program:k}}function G(a,b){function c(a,n){if(a in e){var h=
e[a]|0;d.command(!n||0<=h,"invalid "+a,b.commandStr);return N(function(a,b){n&&(a.OFFSET=h);return h})}if(a in g){var ka=g[a];return ma(ka,function(b,c){var e=b.invoke(c,ka);n&&(b.OFFSET=e,d.optional(function(){b.assert(c,e+">=0","invalid "+a)}));return e})}return n&&f?N(function(a,b){a.OFFSET="0";return 0}):null}var e=a["static"],g=a.dynamic,f=function(){if("elements"in e){var a=e.elements;db(a)?a=l.getElements(l.create(a,!0)):a&&(a=l.getElements(a),d.command(a,"invalid elements",b.commandStr));
var c=N(function(b,d){if(a){var c=b.link(a);return b.ELEMENTS=c}return b.ELEMENTS=null});c.value=a;return c}if("elements"in g){var n=g.elements;return ma(n,function(a,b){var c=a.shared,e=c.isBufferArgs,c=c.elements,g=a.invoke(b,n),f=b.def("null"),e=b.def(e,"(",g,")"),Q=a.cond(e).then(f,"=",c,".createStream(",g,");")["else"](f,"=",c,".getElements(",g,");");d.optional(function(){a.assert(Q["else"],"!"+g+"||"+f,"invalid elements")});b.entry(Q);b.exit(a.cond(e).then(c,".destroyStream(",f,");"));return a.ELEMENTS=
f})}return null}(),h=c("offset",!0);return{elements:f,primitive:function(){if("primitive"in e){var a=e.primitive;d.commandParameter(a,Ha,"invalid primitve",b.commandStr);return N(function(b,d){return Ha[a]})}if("primitive"in g){var c=g.primitive;return ma(c,function(a,b){var e=a.constants.primTypes,g=a.invoke(b,c);d.optional(function(){a.assert(b,g+" in "+e,"invalid primitive, must be one of "+Object.keys(Ha))});return b.def(e,"[",g,"]")})}return f?Ca(f)?f.value?N(function(a,b){return b.def(a.ELEMENTS,
".primType")}):N(function(){return 4}):new pa(f.thisDep,f.contextDep,f.propDep,function(a,b){var d=a.ELEMENTS;return b.def(d,"?",d,".primType:",4)}):null}(),count:function(){if("count"in e){var a=e.count|0;d.command("number"===typeof a&&0<=a,"invalid vertex count",b.commandStr);return N(function(){return a})}if("count"in g){var c=g.count;return ma(c,function(a,b){var e=a.invoke(b,c);d.optional(function(){a.assert(b,"typeof "+e+'==="number"&&'+e+">=0&&"+e+"===("+e+"|0)","invalid vertex count")});return e})}if(f){if(Ca(f)){if(f)return h?
new pa(h.thisDep,h.contextDep,h.propDep,function(a,b){var c=b.def(a.ELEMENTS,".vertCount-",a.OFFSET);d.optional(function(){a.assert(b,c+">=0","invalid vertex offset/element buffer too small")});return c}):N(function(a,b){return b.def(a.ELEMENTS,".vertCount")});var n=N(function(){return-1});d.optional(function(){n.MISSING=!0});return n}var ka=new pa(f.thisDep||h.thisDep,f.contextDep||h.contextDep,f.propDep||h.propDep,function(a,b){var d=a.ELEMENTS;return a.OFFSET?b.def(d,"?",d,".vertCount-",a.OFFSET,
":-1"):b.def(d,"?",d,".vertCount:-1")});d.optional(function(){ka.DYNAMIC=!0});return ka}return null}(),instances:c("instances",!1),offset:h}}function E(a,b){var c=a["static"],e=a.dynamic,g={};ba.forEach(function(a){function n(b,d){if(a in c){var f=b(c[a]);g[h]=N(function(){return f})}else if(a in e){var k=e[a];g[h]=ma(k,function(a,b){return d(a,b,a.invoke(b,k))})}}var h=y(a);switch(a){case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "depth.mask":return n(function(c){d.commandType(c,
"boolean",a,b.commandStr);return c},function(b,c,e){d.optional(function(){b.assert(c,"typeof "+e+'==="boolean"',"invalid flag "+a,b.commandStr)});return e});case "depth.func":return n(function(c){d.commandParameter(c,Oa,"invalid "+a,b.commandStr);return Oa[c]},function(b,c,e){var g=b.constants.compareFuncs;d.optional(function(){b.assert(c,e+" in "+g,"invalid "+a+", must be one of "+Object.keys(Oa))});return c.def(g,"[",e,"]")});case "depth.range":return n(function(a){d.command(S(a)&&2===a.length&&
"number"===typeof a[0]&&"number"===typeof a[1]&&a[0]<=a[1],"depth range is 2d array",b.commandStr);return a},function(a,b,c){d.optional(function(){a.assert(b,a.shared.isArrayLike+"("+c+")&&"+c+".length===2&&typeof "+c+'[0]==="number"&&typeof '+c+'[1]==="number"&&'+c+"[0]<="+c+"[1]","depth range must be a 2d array")});var e=b.def("+",c,"[0]"),g=b.def("+",c,"[1]");return[e,g]});case "blend.func":return n(function(a){d.commandType(a,"object","blend.func",b.commandStr);var c="srcRGB"in a?a.srcRGB:a.src,
e="srcAlpha"in a?a.srcAlpha:a.src,g="dstRGB"in a?a.dstRGB:a.dst;a="dstAlpha"in a?a.dstAlpha:a.dst;d.commandParameter(c,ua,h+".srcRGB",b.commandStr);d.commandParameter(e,ua,h+".srcAlpha",b.commandStr);d.commandParameter(g,ua,h+".dstRGB",b.commandStr);d.commandParameter(a,ua,h+".dstAlpha",b.commandStr);d.command(-1===Hb.indexOf(c+", "+g),"unallowed blending combination (srcRGB, dstRGB) = ("+c+", "+g+")",b.commandStr);return[ua[c],ua[g],ua[e],ua[a]]},function(b,c,e){function g(f,h){var k=c.def('"',f,
h,'" in ',e,"?",e,".",f,h,":",e,".",f);d.optional(function(){b.assert(c,k+" in "+n,"invalid "+a+"."+f+h+", must be one of "+Object.keys(ua))});return k}var n=b.constants.blendFuncs;d.optional(function(){b.assert(c,e+"&&typeof "+e+'==="object"',"invalid blend func, must be an object")});var f=g("src","RGB"),h=g("dst","RGB");d.optional(function(){b.assert(c,b.constants.invalidBlendCombinations+".indexOf("+f+'+", "+'+h+") === -1 ","unallowed blending combination for (srcRGB, dstRGB)")});var k=c.def(n,
"[",f,"]"),ca=c.def(n,"[",g("src","Alpha"),"]"),m=c.def(n,"[",h,"]"),q=c.def(n,"[",g("dst","Alpha"),"]");return[k,m,ca,q]});case "blend.equation":return n(function(c){if("string"===typeof c)return d.commandParameter(c,qa,"invalid "+a,b.commandStr),[qa[c],qa[c]];if("object"===typeof c)return d.commandParameter(c.rgb,qa,a+".rgb",b.commandStr),d.commandParameter(c.alpha,qa,a+".alpha",b.commandStr),[qa[c.rgb],qa[c.alpha]];d.commandRaise("invalid blend.equation",b.commandStr)},function(b,c,e){var g=b.constants.blendEquations,
n=c.def(),f=c.def(),h=b.cond("typeof ",e,'==="string"');d.optional(function(){function c(a,d,e){b.assert(a,e+" in "+g,"invalid "+d+", must be one of "+Object.keys(qa))}c(h.then,a,e);b.assert(h["else"],e+"&&typeof "+e+'==="object"',"invalid "+a);c(h["else"],a+".rgb",e+".rgb");c(h["else"],a+".alpha",e+".alpha")});h.then(n,"=",f,"=",g,"[",e,"];");h["else"](n,"=",g,"[",e,".rgb];",f,"=",g,"[",e,".alpha];");c(h);return[n,f]});case "blend.color":return n(function(a){d.command(S(a)&&4===a.length,"blend.color must be a 4d array",
b.commandStr);return la(4,function(b){return+a[b]})},function(a,b,c){d.optional(function(){a.assert(b,a.shared.isArrayLike+"("+c+")&&"+c+".length===4","blend.color must be a 4d array")});return la(4,function(a){return b.def("+",c,"[",a,"]")})});case "stencil.mask":return n(function(a){d.commandType(a,"number",h,b.commandStr);return a|0},function(a,b,c){d.optional(function(){a.assert(b,"typeof "+c+'==="number"',"invalid stencil.mask")});return b.def(c,"|0")});case "stencil.func":return n(function(c){d.commandType(c,
"object",h,b.commandStr);var e=c.cmp||"keep",g=c.ref||0;c="mask"in c?c.mask:-1;d.commandParameter(e,Oa,a+".cmp",b.commandStr);d.commandType(g,"number",a+".ref",b.commandStr);d.commandType(c,"number",a+".mask",b.commandStr);return[Oa[e],g,c]},function(a,b,c){var e=a.constants.compareFuncs;d.optional(function(){function d(){a.assert(b,Array.prototype.join.call(arguments,""),"invalid stencil.func")}d(c+"&&typeof ",c,'==="object"');d('!("cmp" in ',c,")||(",c,".cmp in ",e,")")});var g=b.def('"cmp" in ',
c,"?",e,"[",c,".cmp]",":",7680),n=b.def(c,".ref|0"),f=b.def('"mask" in ',c,"?",c,".mask|0:-1");return[g,n,f]});case "stencil.opFront":case "stencil.opBack":return n(function(c){d.commandType(c,"object",h,b.commandStr);var e=c.fail||"keep",g=c.zfail||"keep";c=c.zpass||"keep";d.commandParameter(e,Da,a+".fail",b.commandStr);d.commandParameter(g,Da,a+".zfail",b.commandStr);d.commandParameter(c,Da,a+".zpass",b.commandStr);return["stencil.opBack"===a?1029:1028,Da[e],Da[g],Da[c]]},function(b,c,e){function g(f){d.optional(function(){b.assert(c,
'!("'+f+'" in '+e+")||("+e+"."+f+" in "+n+")","invalid "+a+"."+f+", must be one of "+Object.keys(Da))});return c.def('"',f,'" in ',e,"?",n,"[",e,".",f,"]:",7680)}var n=b.constants.stencilOps;d.optional(function(){b.assert(c,e+"&&typeof "+e+'==="object"',"invalid "+a)});return["stencil.opBack"===a?1029:1028,g("fail"),g("zfail"),g("zpass")]});case "polygonOffset.offset":return n(function(a){d.commandType(a,"object",h,b.commandStr);var c=a.factor|0;a=a.units|0;d.commandType(c,"number",h+".factor",b.commandStr);
d.commandType(a,"number",h+".units",b.commandStr);return[c,a]},function(b,c,e){d.optional(function(){b.assert(c,e+"&&typeof "+e+'==="object"',"invalid "+a)});var g=c.def(e,".factor|0"),n=c.def(e,".units|0");return[g,n]});case "cull.face":return n(function(a){var c=0;"front"===a?c=1028:"back"===a&&(c=1029);d.command(!!c,h,b.commandStr);return c},function(a,b,c){d.optional(function(){a.assert(b,c+'==="front"||'+c+'==="back"',"invalid cull.face")});return b.def(c,'==="front"?',1028,":",1029)});case "lineWidth":return n(function(a){d.command("number"===
typeof a&&a>=f.lineWidthDims[0]&&a<=f.lineWidthDims[1],"invalid line width, must positive number between "+f.lineWidthDims[0]+" and "+f.lineWidthDims[1],b.commandStr);return a},function(a,b,c){d.optional(function(){a.assert(b,"typeof "+c+'==="number"&&'+c+">="+f.lineWidthDims[0]+"&&"+c+"<="+f.lineWidthDims[1],"invalid line width")});return c});case "frontFace":return n(function(a){d.commandParameter(a,nb,h,b.commandStr);return nb[a]},function(a,b,c){d.optional(function(){a.assert(b,c+'==="cw"||'+
c+'==="ccw"',"invalid frontFace, must be one of cw,ccw")});return b.def(c+'==="cw"?2304:2305')});case "colorMask":return n(function(a){d.command(S(a)&&4===a.length,"color.mask must be length 4 array",b.commandStr);return a.map(function(a){return!!a})},function(a,b,c){d.optional(function(){a.assert(b,a.shared.isArrayLike+"("+c+")&&"+c+".length===4","invalid color.mask")});return la(4,function(a){return"!!"+c+"["+a+"]"})});case "sample.coverage":return n(function(a){d.command("object"===typeof a&&a,
h,b.commandStr);var c="value"in a?a.value:1;a=!!a.invert;d.command("number"===typeof c&&0<=c&&1>=c,"sample.coverage.value must be a number between 0 and 1",b.commandStr);return[c,a]},function(a,b,c){d.optional(function(){a.assert(b,c+"&&typeof "+c+'==="object"',"invalid sample.coverage")});var e=b.def('"value" in ',c,"?+",c,".value:1"),g=b.def("!!",c,".invert");return[e,g]})}});return g}function F(a,b){var c=a["static"],e=a.dynamic,g={};Object.keys(c).forEach(function(a){var e=c[a],n;if("number"===
typeof e||"boolean"===typeof e)n=N(function(){return e});else if("function"===typeof e){var f=e._reglType;"texture2d"===f||"textureCube"===f?n=N(function(a){return a.link(e)}):"framebuffer"===f||"framebufferCube"===f?(d.command(0<e.color.length,'missing color attachment for framebuffer sent to uniform "'+a+'"',b.commandStr),n=N(function(a){return a.link(e.color[0])})):d.commandRaise('invalid data for uniform "'+a+'"',b.commandStr)}else S(e)?n=N(function(b){return b.global.def("[",la(e.length,function(c){d.command("number"===
typeof e[c]||"boolean"===typeof e[c],"invalid uniform "+a,b.commandStr);return e[c]}),"]")}):d.commandRaise('invalid or missing data for uniform "'+a+'"',b.commandStr);n.value=e;g[a]=n});Object.keys(e).forEach(function(a){var b=e[a];g[a]=ma(b,function(a,c){return a.invoke(c,b)})});return g}function J(a,c){var g=a["static"],f=a.dynamic,h={};Object.keys(g).forEach(function(a){var n=g[a],f=b.id(a),k=new X;if(db(n))k.state=1,k.buffer=e.getBuffer(e.create(n,34962,!1,!0)),k.type=0;else{var m=e.getBuffer(n);
if(m)k.state=1,k.buffer=m,k.type=0;else if(d.command("object"===typeof n&&n,"invalid data for attribute "+a,c.commandStr),n.constant){var q=n.constant;k.buffer="null";k.state=2;"number"===typeof q?k.x=q:(d.command(S(q)&&0<q.length&&4>=q.length,"invalid constant for attribute "+a,c.commandStr),Pa.forEach(function(a,b){b<q.length&&(k[a]=q[b])}))}else{m=db(n.buffer)?e.getBuffer(e.create(n.buffer,34962,!1,!0)):e.getBuffer(n.buffer);d.command(!!m,'missing buffer for attribute "'+a+'"',c.commandStr);var l=
n.offset|0;d.command(0<=l,'invalid offset for attribute "'+a+'"',c.commandStr);var p=n.stride|0;d.command(0<=p&&256>p,'invalid stride for attribute "'+a+'", must be integer betweeen [0, 255]',c.commandStr);var r=n.size|0;d.command(!("size"in n)||0<r&&4>=r,'invalid size for attribute "'+a+'", must be 1,2,3,4',c.commandStr);var ta=!!n.normalized,w=0;"type"in n&&(d.commandParameter(n.type,Sa,"invalid type for attribute "+a,c.commandStr),w=Sa[n.type]);var v=n.divisor|0;"divisor"in n&&(d.command(0===v||
aa,'cannot specify divisor for attribute "'+a+'", instancing not supported',c.commandStr),d.command(0<=v,'invalid divisor for attribute "'+a+'"',c.commandStr));d.optional(function(){var b=c.commandStr,e="buffer offset divisor normalized type size stride".split(" ");Object.keys(n).forEach(function(c){d.command(0<=e.indexOf(c),'unknown parameter "'+c+'" for attribute pointer "'+a+'" (valid parameters are '+e+")",b)})});k.buffer=m;k.state=1;k.size=r;k.normalized=ta;k.type=w||m.dtype;k.offset=l;k.stride=
p;k.divisor=v}}h[a]=N(function(a,b){var c=a.attribCache;if(f in c)return c[f];var d={isStream:!1};Object.keys(k).forEach(function(a){d[a]=k[a]});k.buffer&&(d.buffer=a.link(k.buffer),d.type=d.type||d.buffer+".dtype");return c[f]=d})});Object.keys(f).forEach(function(a){var b=f[a];h[a]=ma(b,function(c,e){function g(a){e(m[a],"=",n,".",a,"|0;")}var n=c.invoke(e,b),f=c.shared,h=f.isBufferArgs,k=f.buffer;d.optional(function(){c.assert(e,n+"&&(typeof "+n+'==="object"||typeof '+n+'==="function")&&('+h+"("+
n+")||"+k+".getBuffer("+n+")||"+k+".getBuffer("+n+".buffer)||"+h+"("+n+'.buffer)||("constant" in '+n+"&&(typeof "+n+'.constant==="number"||'+f.isArrayLike+"("+n+".constant))))",'invalid dynamic attribute "'+a+'"')});var m={isStream:e.def(!1)},ca=new X;ca.state=1;Object.keys(ca).forEach(function(a){m[a]=e.def(""+ca[a])});var q=m.buffer,l=m.type;e("if(",h,"(",n,")){",m.isStream,"=true;",q,"=",k,".createStream(",34962,",",n,");",l,"=",q,".dtype;","}else{",q,"=",k,".getBuffer(",n,");","if(",q,"){",l,
"=",q,".dtype;",'}else if("constant" in ',n,"){",m.state,"=",2,";","if(typeof "+n+'.constant === "number"){',m[Pa[0]],"=",n,".constant;",Pa.slice(1).map(function(a){return m[a]}).join("="),"=0;","}else{",Pa.map(function(a,b){return m[a]+"="+n+".constant.length>="+b+"?"+n+".constant["+b+"]:0;"}).join(""),"}}else{","if(",h,"(",n,".buffer)){",q,"=",k,".createStream(",34962,",",n,".buffer);","}else{",q,"=",k,".getBuffer(",n,".buffer);","}",l,'="type" in ',n,"?",f.glTypes,"[",n,".type]:",q,".dtype;",m.normalized,
"=!!",n,".normalized;");g("size");g("offset");g("stride");g("divisor");e("}}");e.exit("if(",m.isStream,"){",k,".destroyStream(",q,");","}");return m})});return h}function O(a){var b=a["static"],c=a.dynamic,d={};Object.keys(b).forEach(function(a){var c=b[a];d[a]=N(function(a,b){return"number"===typeof c||"boolean"===typeof c?""+c:a.link(c)})});Object.keys(c).forEach(function(a){var b=c[a];d[a]=ma(b,function(a,c){return a.invoke(c,b)})});return d}function P(a,b,c,e,g){function f(a){var b=q[a];b&&(p[a]=
b)}var h=a["static"],k=a.dynamic;d.optional(function(){function a(c){Object.keys(c).forEach(function(a){d.command(0<=b.indexOf(a),'unknown parameter "'+a+'"',g.commandStr)})}var b="framebuffer vert frag elements primitive offset count instances profile".split(" ").concat(ba);a(h);a(k)});var m=z(a,g),q=D(a,m,g),l=G(a,g),p=E(a,g),r=I(a,g);f("viewport");f(y("scissor.box"));var w=0<Object.keys(p).length,m={framebuffer:m,draw:l,shader:r,state:p,dirty:w};m.profile=B(a,g);m.uniforms=F(c,g);m.attributes=
J(b,g);m.context=O(e,g);return m}function fa(a,b,c){var d=a.shared.context,e=a.scope();Object.keys(c).forEach(function(g){b.save(d,"."+g);e(d,".",g,"=",c[g].append(a,b),";")});b(e)}function U(a,b,c,d){var e=a.shared,g=e.gl,f=e.framebuffer,h;ha&&(h=b.def(e.extensions,".webgl_draw_buffers"));var k=a.constants,e=k.drawBuffer,k=k.backBuffer;a=c?c.append(a,b):b.def(f,".next");d||b("if(",a,"!==",f,".cur){");b("if(",a,"){",g,".bindFramebuffer(",36160,",",a,".framebuffer);");ha&&b(h,".drawBuffersWEBGL(",
e,"[",a,".colorAttachments.length]);");b("}else{",g,".bindFramebuffer(",36160,",null);");ha&&b(h,".drawBuffersWEBGL(",k,");");b("}",f,".cur=",a,";");d||b("}")}function V(a,b,c){var d=a.shared,e=d.gl,g=a.current,f=a.next,h=d.current,k=d.next,m=a.cond(h,".dirty");ba.forEach(function(b){b=y(b);if(!(b in c.state)){var d,q;if(b in f){d=f[b];q=g[b];var l=la(za[b].length,function(a){return m.def(d,"[",a,"]")});m(a.cond(l.map(function(a,b){return a+"!=="+q+"["+b+"]"}).join("||")).then(e,".",Ba[b],"(",l,");",
l.map(function(a,b){return q+"["+b+"]="+a}).join(";"),";"))}else d=m.def(k,".",b),l=a.cond(d,"!==",h,".",b),m(l),b in Aa?l(a.cond(d).then(e,".enable(",Aa[b],");")["else"](e,".disable(",Aa[b],");"),h,".",b,"=",d,";"):l(e,".",Ba[b],"(",d,");",h,".",b,"=",d,";")}});0===Object.keys(c.state).length&&m(h,".dirty=false;");b(m)}function M(a,b,c,d){var e=a.shared,g=a.current,f=e.current,h=e.gl;Gb(Object.keys(c)).forEach(function(e){var k=c[e];if(!d||d(k)){var m=k.append(a,b);if(Aa[e]){var q=Aa[e];Ca(k)?m?
b(h,".enable(",q,");"):b(h,".disable(",q,");"):b(a.cond(m).then(h,".enable(",q,");")["else"](h,".disable(",q,");"));b(f,".",e,"=",m,";")}else if(S(m)){var l=g[e];b(h,".",Ba[e],"(",m,");",m.map(function(a,b){return l+"["+b+"]="+a}).join(";"),";")}else b(h,".",Ba[e],"(",m,");",f,".",e,"=",m,";")}})}function L(a,b){aa&&(a.instancing=b.def(a.shared.extensions,".angle_instanced_arrays"))}function ga(a,b,c,d,e){function g(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function f(a){r=
b.def();a(r,"=",g(),";");"string"===typeof e?a(q,".count+=",e,";"):a(q,".count++;");v&&(d?(w=b.def(),a(w,"=",p,".getNumPendingQueries();")):a(p,".beginQuery(",q,");"))}function h(a){a(q,".cpuTime+=",g(),"-",r,";");v&&(d?a(p,".pushScopeStats(",w,",",p,".getNumPendingQueries(),",q,");"):a(p,".endQuery();"))}function k(a){var c=b.def(l,".profile");b(l,".profile=",a,";");b.exit(l,".profile=",c,";")}var m=a.shared,q=a.stats,l=m.current,p=m.timer;c=c.profile;var r,w;if(c){if(Ca(c)){c.enable?(f(b),h(b.exit),
k("true")):k("false");return}c=c.append(a,b);k(c)}else c=b.def(l,".profile");m=a.block();f(m);b("if(",c,"){",m,"}");a=a.block();h(a);b.exit("if(",c,"){",a,"}")}function T(a,b,c,e,g){function f(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}function h(c,d,e){function g(){b("if(!",l,".buffer){",m,".enableVertexAttribArray(",q,");}");var c=e.type,f;f=e.size?b.def(e.size,"||",d):d;b("if(",l,".type!==",
c,"||",l,".size!==",f,"||",w.map(function(a){return l+"."+a+"!=="+e[a]}).join("||"),"){",m,".bindBuffer(",34962,",",p,".buffer);",m,".vertexAttribPointer(",[q,f,c,e.normalized,e.stride,e.offset],");",l,".type=",c,";",l,".size=",f,";",w.map(function(a){return l+"."+a+"="+e[a]+";"}).join(""),"}");aa&&(c=e.divisor,b("if(",l,".divisor!==",c,"){",a.instancing,".vertexAttribDivisorANGLE(",[q,c],");",l,".divisor=",c,";}"))}function f(){b("if(",l,".buffer){",m,".disableVertexAttribArray(",q,");","}if(",Pa.map(function(a,
b){return l+"."+a+"!=="+r[b]}).join("||"),"){",m,".vertexAttrib4f(",q,",",r,");",Pa.map(function(a,b){return l+"."+a+"="+r[b]+";"}).join(""),"}")}var m=k.gl,q=b.def(c,".location"),l=b.def(k.attributes,"[",q,"]");c=e.state;var p=e.buffer,r=[e.x,e.y,e.z,e.w],w=["buffer","normalized","offset","stride"];1===c?g():2===c?f():(b("if(",c,"===",1,"){"),g(),b("}else{"),f(),b("}"))}var k=a.shared;e.forEach(function(e){var k=e.name,m=c.attributes[k],q;if(m){if(!g(m))return;q=m.append(a,b)}else{if(!g(Jb))return;
var l=a.scopeAttrib(k);d.optional(function(){a.assert(b,l+".state","missing attribute "+k)});q={};Object.keys(new X).forEach(function(a){q[a]=b.def(l,".",a)})}h(a.link(e),f(e.info.type),q)})}function W(a,c,e,g,f){for(var h=a.shared,k=h.gl,m,q=0;q<g.length;++q){var l=g[q],p=l.name,r=l.info.type,w=e.uniforms[p],l=a.link(l)+".location",v;if(w){if(!f(w))continue;if(Ca(w)){var t=w.value;d.command(null!==t&&"undefined"!==typeof t,'missing uniform "'+p+'"',a.commandStr);if(35678===r||35680===r)d.command("function"===
typeof t&&(35678===r&&("texture2d"===t._reglType||"framebuffer"===t._reglType)||35680===r&&("textureCube"===t._reglType||"framebufferCube"===t._reglType)),"invalid texture for uniform "+p,a.commandStr),w=a.link(t._texture||t.color[0]._texture),c(k,".uniform1i(",l,",",w+".bind());"),c.exit(w,".unbind();");else if(35674===r||35675===r||35676===r){d.optional(function(){d.command(S(t),"invalid matrix for uniform "+p,a.commandStr);d.command(35674===r&&4===t.length||35675===r&&9===t.length||35676===r&&
16===t.length,"invalid length for matrix uniform "+p,a.commandStr)});var w=a.global.def("new Float32Array(["+Array.prototype.slice.call(t)+"])"),u=2;35675===r?u=3:35676===r&&(u=4);c(k,".uniformMatrix",u,"fv(",l,",false,",w,");")}else{switch(r){case 5126:d.commandType(t,"number","uniform "+p,a.commandStr);m="1f";break;case 35664:d.command(S(t)&&2===t.length,"uniform "+p,a.commandStr);m="2f";break;case 35665:d.command(S(t)&&3===t.length,"uniform "+p,a.commandStr);m="3f";break;case 35666:d.command(S(t)&&
4===t.length,"uniform "+p,a.commandStr);m="4f";break;case 35670:d.commandType(t,"boolean","uniform "+p,a.commandStr);m="1i";break;case 5124:d.commandType(t,"number","uniform "+p,a.commandStr);m="1i";break;case 35671:d.command(S(t)&&2===t.length,"uniform "+p,a.commandStr);m="2i";break;case 35667:d.command(S(t)&&2===t.length,"uniform "+p,a.commandStr);m="2i";break;case 35672:d.command(S(t)&&3===t.length,"uniform "+p,a.commandStr);m="3i";break;case 35668:d.command(S(t)&&3===t.length,"uniform "+p,a.commandStr);
m="3i";break;case 35673:d.command(S(t)&&4===t.length,"uniform "+p,a.commandStr);m="4i";break;case 35669:d.command(S(t)&&4===t.length,"uniform "+p,a.commandStr),m="4i"}c(k,".uniform",m,"(",l,",",S(t)?Array.prototype.slice.call(t):t,");")}continue}else v=w.append(a,c)}else{if(!f(Jb))continue;v=c.def(h.uniforms,"[",b.id(p),"]")}35678===r?c("if(",v,"&&",v,'._reglType==="framebuffer"){',v,"=",v,".color[0];","}"):35680===r&&c("if(",v,"&&",v,'._reglType==="framebufferCube"){',v,"=",v,".color[0];","}");d.optional(function(){function b(d,
e){a.assert(c,d,'bad data or missing for uniform "'+p+'".  '+e)}function d(a){b("typeof "+v+'==="'+a+'"',"invalid type, expected "+a)}function e(c,d){b(h.isArrayLike+"("+v+")&&"+v+".length==="+c,"invalid vector, should have length "+c,a.commandStr)}function g(c){b("typeof "+v+'==="function"&&'+v+'._reglType==="texture'+(3553===c?"2d":"Cube")+'"',"invalid texture type",a.commandStr)}switch(r){case 5124:d("number");break;case 35667:e(2,"number");break;case 35668:e(3,"number");break;case 35669:e(4,"number");
break;case 5126:d("number");break;case 35664:e(2,"number");break;case 35665:e(3,"number");break;case 35666:e(4,"number");break;case 35670:d("boolean");break;case 35671:e(2,"boolean");break;case 35672:e(3,"boolean");break;case 35673:e(4,"boolean");break;case 35674:e(4,"number");break;case 35675:e(9,"number");break;case 35676:e(16,"number");break;case 35678:g(3553);break;case 35680:g(34067)}});w=1;switch(r){case 35678:case 35680:w=c.def(v,"._texture");c(k,".uniform1i(",l,",",w,".bind());");c.exit(w,
".unbind();");continue;case 5124:case 35670:m="1i";break;case 35667:case 35671:m="2i";w=2;break;case 35668:case 35672:m="3i";w=3;break;case 35669:case 35673:m="4i";w=4;break;case 5126:m="1f";break;case 35664:m="2f";w=2;break;case 35665:m="3f";w=3;break;case 35666:m="4f";w=4;break;case 35674:m="Matrix2fv";break;case 35675:m="Matrix3fv";break;case 35676:m="Matrix4fv"}c(k,".uniform",m,"(",l,",");if("M"===m.charAt(0)){var l=Math.pow(r-35674+2,2),H=a.global.def("new Float32Array(",l,")");c("false,(Array.isArray(",
v,")||",v," instanceof Float32Array)?",v,":(",la(l,function(a){return H+"["+a+"]="+v+"["+a+"]"}),",",H,")")}else 1<w?c(la(w,function(a){return v+"["+a+"]"})):c(v);c(");")}}function Y(a,b,c,e){function g(d){var f=l[d];return f?f.contextDep&&e.contextDynamic||f.propDep?f.append(a,c):f.append(a,b):b.def(q,".",d)}function f(){function a(){c(u,".drawElementsInstancedANGLE(",[r,t,H,w+"<<(("+H+"-5121)>>1)",v],");")}function b(){c(u,".drawArraysInstancedANGLE(",[r,w,t,v],");")}p?x?a():(c("if(",p,"){"),a(),
c("}else{"),b(),c("}")):b()}function h(){function a(){c(m+".drawElements("+[r,t,H,w+"<<(("+H+"-5121)>>1)"]+");")}function b(){c(m+".drawArrays("+[r,w,t]+");")}p?x?a():(c("if(",p,"){"),a(),c("}else{"),b(),c("}")):b()}var k=a.shared,m=k.gl,q=k.draw,l=e.draw,p=function(){var d=l.elements,g=b;if(d){if(d.contextDep&&e.contextDynamic||d.propDep)g=c;d=d.append(a,g)}else d=g.def(q,".","elements");d&&g("if("+d+")"+m+".bindBuffer(34963,"+d+".buffer.buffer);");return d}(),r=g("primitive"),w=g("offset"),t=function(){var g=
l.count,f,h=b;if(g){if(g.contextDep&&e.contextDynamic||g.propDep)h=c;f=g.append(a,h);d.optional(function(){g.MISSING&&a.assert(b,"false","missing vertex count");g.DYNAMIC&&a.assert(h,f+">=0","missing vertex count")})}else f=h.def(q,".","count"),d.optional(function(){a.assert(h,f+">=0","missing vertex count")});return f}();if("number"===typeof t){if(0===t)return}else c("if(",t,"){"),c.exit("}");var v,u;aa&&(v=g("instances"),u=a.instancing);var H=p+".type",x=l.elements&&Ca(l.elements);aa&&("number"!==
typeof v||0<=v)?"string"===typeof v?(c("if(",v,">0){"),f(),c("}else if(",v,"<0){"),h(),c("}")):f():h()}function Z(a,b,c,e,g){var f=C();g=f.proc("body",g);d.optional(function(){f.commandStr=b.commandStr;f.command=f.link(b.commandStr)});aa&&(f.instancing=g.def(f.shared.extensions,".angle_instanced_arrays"));a(f,g,c,e);return f.compile().body}function ea(a,b,c,d){L(a,b);T(a,b,c,d.attributes,function(){return!0});W(a,b,c,d.uniforms,function(){return!0});Y(a,b,b,c)}function gb(a,b){var c=a.proc("draw",
1);L(a,c);fa(a,c,b.context);U(a,c,b.framebuffer);V(a,c,b);M(a,c,b.state);ga(a,c,b,!1,!0);var d=b.shader.progVar.append(a,c);c(a.shared.gl,".useProgram(",d,".program);");if(b.shader.program)ea(a,c,b,b.shader.program);else{var e=a.global.def("{}"),g=c.def(d,".id"),f=c.def(e,"[",g,"]");c(a.cond(f).then(f,".call(this,a0);")["else"](f,"=",e,"[",g,"]=",a.link(function(c){return Z(ea,a,b,c,1)}),"(",d,");",f,".call(this,a0);"))}0<Object.keys(b.state).length&&c(a.shared.current,".dirty=true;")}function ra(a,
b,c,d){function e(){return!0}a.batchId="a1";L(a,b);T(a,b,c,d.attributes,e);W(a,b,c,d.uniforms,e);Y(a,b,b,c)}function Fa(a,b,c,d){function e(a){return a.contextDep&&f||a.propDep}function g(a){return!e(a)}L(a,b);var f=c.contextDep,h=b.def(),k=b.def();a.shared.props=k;a.batchId=h;var m=a.scope(),q=a.scope();b(m.entry,"for(",h,"=0;",h,"<","a1",";++",h,"){",k,"=","a0","[",h,"];",q,"}",m.exit);c.needsContext&&fa(a,q,c.context);c.needsFramebuffer&&U(a,q,c.framebuffer);M(a,q,c.state,e);c.profile&&e(c.profile)&&
ga(a,q,c,!1,!0);d?(T(a,m,c,d.attributes,g),T(a,q,c,d.attributes,e),W(a,m,c,d.uniforms,g),W(a,q,c,d.uniforms,e),Y(a,m,q,c)):(b=a.global.def("{}"),d=c.shader.progVar.append(a,q),k=q.def(d,".id"),m=q.def(b,"[",k,"]"),q(a.shared.gl,".useProgram(",d,".program);","if(!",m,"){",m,"=",b,"[",k,"]=",a.link(function(b){return Z(ra,a,c,b,2)}),"(",d,");}",m,".call(this,a0[",h,"],",h,");"))}function Ga(a,b){function c(a){return a.contextDep&&e||a.propDep}var d=a.proc("batch",2);a.batchId="0";L(a,d);var e=!1,g=
!0;Object.keys(b.context).forEach(function(a){e=e||b.context[a].propDep});e||(fa(a,d,b.context),g=!1);var f=b.framebuffer,h=!1;f?(f.propDep?e=h=!0:f.contextDep&&e&&(h=!0),h||U(a,d,f)):U(a,d,null);b.state.viewport&&b.state.viewport.propDep&&(e=!0);V(a,d,b);M(a,d,b.state,function(a){return!c(a)});b.profile&&c(b.profile)||ga(a,d,b,!1,"a1");b.contextDep=e;b.needsContext=g;b.needsFramebuffer=h;g=b.shader.progVar;if(g.contextDep&&e||g.propDep)Fa(a,d,b,null);else if(g=g.append(a,d),d(a.shared.gl,".useProgram(",
g,".program);"),b.shader.program)Fa(a,d,b,b.shader.program);else{var f=a.global.def("{}"),h=d.def(g,".id"),k=d.def(f,"[",h,"]");d(a.cond(k).then(k,".call(this,a0,a1);")["else"](k,"=",f,"[",h,"]=",a.link(function(c){return Z(Fa,a,b,c,2)}),"(",g,");",k,".call(this,a0,a1);"))}0<Object.keys(b.state).length&&d(a.shared.current,".dirty=true;")}function lb(a,c){function d(b){var f=c.shader[b];f&&e.set(g.shader,"."+b,f.append(a,e))}var e=a.proc("scope",3);a.batchId="a2";var g=a.shared,f=g.current;fa(a,e,
c.context);c.framebuffer&&c.framebuffer.append(a,e);Gb(Object.keys(c.state)).forEach(function(b){var d=c.state[b].append(a,e);S(d)?d.forEach(function(c,d){e.set(a.next[b],"["+d+"]",c)}):e.set(g.next,"."+b,d)});ga(a,e,c,!0,!0);["elements","offset","count","instances","primitive"].forEach(function(b){var d=c.draw[b];d&&e.set(g.draw,"."+b,""+d.append(a,e))});Object.keys(c.uniforms).forEach(function(d){e.set(g.uniforms,"["+b.id(d)+"]",c.uniforms[d].append(a,e))});Object.keys(c.attributes).forEach(function(b){var d=
c.attributes[b].append(a,e),g=a.scopeAttrib(b);Object.keys(new X).forEach(function(a){e.set(g,"."+a,d[a])})});d("vert");d("frag");0<Object.keys(c.state).length&&(e(f,".dirty=true;"),e.exit(f,".dirty=true;"));e("a1(",a.shared.context,",a0,",a.batchId,");")}function fb(a){if("object"===typeof a&&!S(a)){for(var b=Object.keys(a),c=0;c<b.length;++c)if(sa.isDynamic(a[b[c]]))return!0;return!1}}function ia(a,b,c){function d(a,b){f.forEach(function(c){var d=e[c];sa.isDynamic(d)&&(d=a.invoke(b,d),b(q,".",c,
"=",d,";"))})}var e=b["static"][c];if(e&&fb(e)){var g=a.global,f=Object.keys(e),h=!1,k=!1,m=!1,q=a.global.def("{}");f.forEach(function(b){var c=e[b];if(sa.isDynamic(c))"function"===typeof c&&(c=e[b]=sa.unbox(c)),b=ma(c,null),h=h||b.thisDep,m=m||b.propDep,k=k||b.contextDep;else{g(q,".",b,"=");switch(typeof c){case "number":g(c);break;case "string":g('"',c,'"');break;case "object":Array.isArray(c)&&g("[",c.join(),"]");break;default:g(a.link(c))}g(";")}});b.dynamic[c]=new sa.DynamicVariable(4,{thisDep:h,
contextDep:k,propDep:m,ref:q,append:d});delete b["static"][c]}}var X=r.Record,qa={add:32774,subtract:32778,"reverse subtract":32779};c.ext_blend_minmax&&(qa.min=32775,qa.max=32776);var aa=c.angle_instanced_arrays,ha=c.webgl_draw_buffers,za={dirty:!0,profile:k.profile},Ta={},ba=[],Aa={},Ba={};A("dither",3024);A("blend.enable",3042);x("blend.color","blendColor",[0,0,0,0]);x("blend.equation","blendEquationSeparate",[32774,32774]);x("blend.func","blendFuncSeparate",[1,0,1,0]);A("depth.enable",2929,!0);
x("depth.func","depthFunc",513);x("depth.range","depthRange",[0,1]);x("depth.mask","depthMask",!0);x("colorMask","colorMask",[!0,!0,!0,!0]);A("cull.enable",2884);x("cull.face","cullFace",1029);x("frontFace","frontFace",2305);x("lineWidth","lineWidth",1);A("polygonOffset.enable",32823);x("polygonOffset.offset","polygonOffset",[0,0]);A("sample.alpha",32926);A("sample.enable",32928);x("sample.coverage","sampleCoverage",[1,!1]);A("stencil.enable",2960);x("stencil.mask","stencilMask",-1);x("stencil.func",
"stencilFunc",[519,0,-1]);x("stencil.opFront","stencilOpSeparate",[1028,7680,7680,7680]);x("stencil.opBack","stencilOpSeparate",[1029,7680,7680,7680]);A("scissor.enable",3089);x("scissor.box","scissor",[0,0,a.drawingBufferWidth,a.drawingBufferHeight]);x("viewport","viewport",[0,0,a.drawingBufferWidth,a.drawingBufferHeight]);var kb={gl:a,context:u,strings:b,next:Ta,current:za,draw:w,elements:l,buffer:e,shader:p,attributes:r.state,uniforms:g,framebuffer:h,extensions:c,timer:v,isBufferArgs:db},ja={primTypes:Ha,
compareFuncs:Oa,blendFuncs:ua,blendEquations:qa,stencilOps:Da,glTypes:Sa,orientationType:nb};d.optional(function(){kb.isArrayLike=S});ha&&(ja.backBuffer=[1029],ja.drawBuffer=la(f.maxDrawbuffers,function(a){return 0===a?[0]:la(a,function(a){return 36064+a})}));var Va=0;return{next:Ta,current:za,procs:function(){var b=C(),c=b.proc("poll"),d=b.proc("refresh"),e=b.block();c(e);d(e);var g=b.shared,h=g.gl,k=g.next,q=g.current;e(q,".dirty=false;");U(b,c);U(b,d,null,!0);var l=a.getExtension("angle_instanced_arrays"),
p;l&&(p=b.link(l));for(var r=0;r<f.maxAttributes;++r){var t=d.def(g.attributes,"[",r,"]"),w=b.cond(t,".buffer");w.then(h,".enableVertexAttribArray(",r,");",h,".bindBuffer(",34962,",",t,".buffer.buffer);",h,".vertexAttribPointer(",r,",",t,".size,",t,".type,",t,".normalized,",t,".stride,",t,".offset);")["else"](h,".disableVertexAttribArray(",r,");",h,".vertexAttrib4f(",r,",",t,".x,",t,".y,",t,".z,",t,".w);",t,".buffer=null;");d(w);l&&d(p,".vertexAttribDivisorANGLE(",r,",",t,".divisor);")}Object.keys(Aa).forEach(function(a){var g=
Aa[a],f=e.def(k,".",a),m=b.block();m("if(",f,"){",h,".enable(",g,")}else{",h,".disable(",g,")}",q,".",a,"=",f,";");d(m);c("if(",f,"!==",q,".",a,"){",m,"}")});Object.keys(Ba).forEach(function(a){var g=Ba[a],f=za[a],m,l,p=b.block();p(h,".",g,"(");S(f)?(g=f.length,m=b.global.def(k,".",a),l=b.global.def(q,".",a),p(la(g,function(a){return m+"["+a+"]"}),");",la(g,function(a){return l+"["+a+"]="+m+"["+a+"];"}).join("")),c("if(",la(g,function(a){return m+"["+a+"]!=="+l+"["+a+"]"}).join("||"),"){",p,"}")):
(m=e.def(k,".",a),l=e.def(q,".",a),p(m,");",q,".",a,"=",m,";"),c("if(",m,"!==",l,"){",p,"}"));d(p)});return b.compile()}(),compile:function(a,b,c,d,e){var g=C();g.stats=g.link(e);Object.keys(b["static"]).forEach(function(a){ia(g,b,a)});fc.forEach(function(b){ia(g,a,b)});c=P(a,b,c,d,g);gb(g,c);lb(g,c);Ga(g,c);return g.compile()}}}function Kb(a,b){for(var c=0;c<a.length;++c)if(a[c]===b)return c;return-1}var Ra={"[object Int8Array]":5120,"[object Int16Array]":5122,"[object Int32Array]":5124,"[object Uint8Array]":5121,
"[object Uint8ClampedArray]":5121,"[object Uint16Array]":5123,"[object Uint32Array]":5125,"[object Float32Array]":5126,"[object Float64Array]":5121,"[object ArrayBuffer]":5121},Y=function(a){return Object.prototype.toString.call(a)in Ra},V=function(a,b){for(var c=Object.keys(b),d=0;d<c.length;++d)a[c[d]]=b[c[d]];return a},Lb="gl canvas container attributes pixelRatio extensions optionalExtensions profile onDone".split(" "),ea={};ea[5120]=ea[5121]=1;ea[5122]=ea[5123]=ea[36193]=ea[33635]=ea[32819]=
ea[32820]=2;ea[5124]=ea[5125]=ea[5126]=ea[34042]=4;var d=V(l,{optional:function(a){a()},raise:c,commandRaise:I,command:function(a,b,c){a||I(b,c||x())},parameter:function(a,b,d){a in b||c("unknown parameter ("+a+")"+u(d)+". possible values: "+Object.keys(b).join())},commandParameter:function(a,b,c,d){a in b||I("unknown parameter ("+a+")"+u(c)+". possible values: "+Object.keys(b).join(),d||x())},constructor:function(a){Object.keys(a).forEach(function(a){0>Lb.indexOf(a)&&c('invalid regl constructor argument "'+
a+'". must be one of '+Lb)})},type:function(a,b,d){typeof a!==b&&c("invalid parameter type"+u(d)+". expected "+b+", got "+typeof a)},commandType:Z,isTypedArray:function(a,b){Y(a)||c("invalid parameter type"+u(b)+". must be a typed array")},nni:function(a,b){0<=a&&(a|0)===a||c("invalid parameter type, ("+a+")"+u(b)+". must be a nonnegative integer")},oneOf:t,shaderError:function(a,b,c,d,e){if(!a.getShaderParameter(b,a.COMPILE_STATUS)){b=a.getShaderInfoLog(b);a=d===a.FRAGMENT_SHADER?"fragment":"vertex";
Z(c,"string",a+" shader source must be a string",e);var f=F(c,e);c=C(b);eb(f,c);Object.keys(f).forEach(function(a){function b(a,c){d.push(a);e.push(c||"")}var c=f[a];if(c.hasErrors){var d=[""],e=[""];b("file number "+a+": "+c.name+"\n","color:red;text-decoration:underline;font-weight:bold");c.lines.forEach(function(a){if(0<a.errors.length){b(A(a.number,4)+"|  ","background-color:yellow; font-weight:bold");b(a.line+"\n","color:red; background-color:yellow; font-weight:bold");var c=0;a.errors.forEach(function(d){d=
d.message;var e=/^\s*\'(.*)\'\s*\:\s*(.*)$/.exec(d);if(e){var g=e[1];d=e[2];switch(g){case "assign":g="="}c=Math.max(a.line.indexOf(g,c),0)}else c=0;b(A("| ",6));b(A("^^^",c+3)+"\n","font-weight:bold");b(A("| ",6));b(d+"\n","font-weight:bold")});b(A("| ",6)+"\n")}else b(A(a.number,4)+"|  "),b(a.line+"\n","color:red")});"undefined"!==typeof document?(e[0]=d.join("%c"),console.log.apply(console,e)):console.log(d.join(""))}});l.raise("Error compiling "+a+" shader, "+f[0].name)}},linkError:function(a,
b,c,d,e){a.getProgramParameter(b,a.LINK_STATUS)||(a=a.getProgramInfoLog(b),c=F(c,e),d='Error linking program with vertex shader, "'+F(d,e)[0].name+'", and fragment shader "'+c[0].name+'"',"undefined"!==typeof document?console.log("%c"+d+"\n%c"+a,"color:red;text-decoration:underline;font-weight:bold","color:red"):console.log(d+"\n"+a),l.raise(d))},callSite:B,saveCommandRef:G,saveDrawInfo:function(a,b,c,d){function e(a){return a?d.id(a):0}function f(a,b){Object.keys(b).forEach(function(b){a[d.id(b)]=
!0})}G(a);a._fragId=e(a["static"].frag);a._vertId=e(a["static"].vert);var l=a._uniformSet={};f(l,b["static"]);f(l,b.dynamic);b=a._attributeSet={};f(b,c["static"]);f(b,c.dynamic);a._hasCount="count"in a["static"]||"count"in a.dynamic||"elements"in a["static"]||"elements"in a.dynamic},framebufferFormat:function(a,b,c){a.texture?t(a.texture._texture.internalformat,b,"unsupported texture format for attachment"):t(a.renderbuffer._renderbuffer.format,c,"unsupported renderbuffer format for attachment")},
guessCommand:x,texture2D:function(a,b,c){var d=b.width,e=b.height,f=b.channels;l(0<d&&d<=c.maxTextureSize&&0<e&&e<=c.maxTextureSize,"invalid texture shape");33071===a.wrapS&&33071===a.wrapT||l(!(d&d-1)&&!!d&&!(e&e-1)&&!!e,"incompatible wrap mode for texture, both width and height must be power of 2");1===b.mipmask?1!==d&&1!==e&&l(9984!==a.minFilter&&9986!==a.minFilter&&9985!==a.minFilter&&9987!==a.minFilter,"min filter requires mipmap"):(l(!(d&d-1)&&!!d&&!(e&e-1)&&!!e,"texture must be a square power of 2 to support mipmapping"),
l(b.mipmask===(d<<1)-1,"missing or incomplete mipmap data"));5126===b.type&&(0>c.extensions.indexOf("oes_texture_float_linear")&&l(9728===a.minFilter&&9728===a.magFilter,"filter not supported, must enable oes_texture_float_linear"),l(!a.genMipmaps,"mipmap generation not supported with float textures"));var t=b.images;for(c=0;16>c;++c)if(t[c]){var h=d>>c,g=e>>c;l(b.mipmask&1<<c,"missing mipmap data");var r=t[c];l(r.width===h&&r.height===g,"invalid shape for mip images");l(r.format===b.format&&r.internalformat===
b.internalformat&&r.type===b.type,"incompatible type for mip image");!r.compressed&&r.data&&(h=Math.ceil(ja(r.type,f)*h/r.unpackAlignment)*r.unpackAlignment,l(r.data.byteLength===h*g,"invalid data for image, buffer size is inconsistent with image format"))}else a.genMipmaps||l(0===(b.mipmask&1<<c),"extra mipmap data");b.compressed&&l(!a.genMipmaps,"mipmap generation for compressed images not supported")},textureCube:function(a,b,c,d){var e=a.width,f=a.height,t=a.channels;l(0<e&&e<=d.maxTextureSize&&
0<f&&f<=d.maxTextureSize,"invalid texture shape");l(e===f,"cube map must be square");l(33071===b.wrapS&&33071===b.wrapT,"wrap mode not supported by cube map");for(d=0;d<c.length;++d){var h=c[d];l(h.width===e&&h.height===f,"inconsistent cube map face shape");b.genMipmaps&&(l(!h.compressed,"can not generate mipmap for compressed textures"),l(1===h.mipmask,"can not specify mipmaps and generate mipmaps"));for(var g=h.images,r=0;16>r;++r){var p=g[r];if(p){var w=e>>r,u=f>>r;l(h.mipmask&1<<r,"missing mipmap data");
l(p.width===w&&p.height===u,"invalid shape for mip images");l(p.format===a.format&&p.internalformat===a.internalformat&&p.type===a.type,"incompatible type for mip image");p.compressed||p.data&&l(p.data.byteLength===w*u*Math.max(ja(p.type,t),p.unpackAlignment),"invalid data for image, buffer size is inconsistent with image format")}}}}}),Nb=0,sa={DynamicVariable:O,define:function(a,b){return new O(a,fa(b+""))},isDynamic:function(a){return"function"===typeof a&&!a._reglType||a instanceof O},unbox:function(a,
b){return"function"===typeof a?new O(0,a):a},accessor:fa},ob={next:"function"===typeof requestAnimationFrame?function(a){return requestAnimationFrame(a)}:function(a){return setTimeout(a,16)},cancel:"function"===typeof cancelAnimationFrame?function(a){return cancelAnimationFrame(a)}:clearTimeout},Mb="undefined"!==typeof performance&&performance.now?function(){return performance.now()}:function(){return+new Date},gc=function(a,b){var c=1;b.ext_texture_filter_anisotropic&&(c=a.getParameter(34047));var d=
...
aa=function(a){return Object.keys(a).map(function(b){return a[b]})},rb=la(8,function(){return[]}),W={alloc:xa,free:sb,allocType:function(a,b){var c=null;switch(a){case 5120:c=new Int8Array(xa(b),0,b);break;case 5121:c=new Uint8Array(xa(b),0,b);break;case 5122:c=new Int16Array(xa(2*b),0,b);break;case 5123:c=new Uint16Array(xa(2*b),0,b);break;case 5124:c=new Int32Array(xa(4*b),0,b);break;case 5125:c=new Uint32Array(xa(4*b),0,b);break;case 5126:c=new Float32Array(xa(4*b),0,b);break;default:return null}return c.length!==
b?c.subarray(0,b):c},freeType:function(a){sb(a.buffer)}},$a={shape:function(a){for(var b=[];a.length;a=a[0])b.push(a.length);return b},flatten:function(a,b,c,d){var e=1;if(b.length)for(var f=0;f<b.length;++f)e*=b[f];else e=0;c=d||W.allocType(c,e);switch(b.length){case 0:break;case 1:d=b[0];for(b=0;b<d;++b)c[b]=a[b];break;case 2:d=b[0];b=b[1];for(f=e=0;f<d;++f)for(var l=a[f],h=0;h<b;++h)c[e++]=l[h];break;case 3:tb(a,b[0],b[1],b[2],c,0);break;default:ub(a,b,0,c,0)}return c}},Sa={int8:5120,int16:5122,
int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126},Xa={dynamic:35048,stream:35040,"static":35044},hb=$a.flatten,xb=$a.shape,ya=[];ya[5120]=1;ya[5122]=2;ya[5124]=4;ya[5121]=1;ya[5123]=2;ya[5125]=4;ya[5126]=4;var Ha={points:0,point:0,lines:1,line:1,triangles:4,triangle:4,"line loop":2,"line strip":3,"triangle strip":5,"triangle fan":6},zb=new Float32Array(1),Tb=new Uint32Array(zb.buffer),Wb=[9984,9986,9985,9987],Za=[0,6409,6410,6407,6408],ia={};ia[6409]=ia[6406]=ia[6402]=1;ia[34041]=
ia[6410]=2;ia[6407]=ia[35904]=3;ia[6408]=ia[35906]=4;var Ub=Object.keys(Ra).concat(["[object HTMLCanvasElement]","[object CanvasRenderingContext2D]","[object HTMLImageElement]","[object HTMLVideoElement]"]),Ja=[];Ja[5121]=1;Ja[5126]=4;Ja[36193]=2;Ja[5123]=2;Ja[5125]=4;var M=[];M[32854]=2;M[32855]=2;M[36194]=2;M[34041]=4;M[33776]=.5;M[33777]=.5;M[33778]=1;M[33779]=1;M[35986]=.5;M[35987]=1;M[34798]=1;M[35840]=.5;M[35841]=.25;M[35842]=.5;M[35843]=.25;M[36196]=.5;var X=[];X[32854]=2;X[32855]=2;X[36194]=
2;X[33189]=2;X[36168]=1;X[34041]=4;X[35907]=4;X[34836]=16;X[34842]=8;X[34843]=6;var hc=function(a,b,c,f,e){function l(a){this.id=r++;this.refCount=1;this.renderbuffer=a;this.format=32854;this.height=this.width=0;e.profile&&(this.stats={size:0})}function t(b){var c=b.renderbuffer;d(c,"must not double destroy renderbuffer");a.bindRenderbuffer(36161,null);a.deleteRenderbuffer(c);b.renderbuffer=null;b.refCount=0;delete p[b.id];f.renderbufferCount--}var h={rgba4:32854,rgb565:36194,"rgb5 a1":32855,depth:33189,
stencil:36168,"depth stencil":34041};b.ext_srgb&&(h.srgba=35907);b.ext_color_buffer_half_float&&(h.rgba16f=34842,h.rgb16f=34843);b.webgl_color_buffer_float&&(h.rgba32f=34836);var g=[];Object.keys(h).forEach(function(a){g[h[a]]=a});var r=0,p={};l.prototype.decRef=function(){0>=--this.refCount&&t(this)};e.profile&&(f.getTotalRenderbufferSize=function(){var a=0;Object.keys(p).forEach(function(b){a+=p[b].stats.size});return a});return{create:function(b,t){function r(b,f){var m=0,l=0,p=32854;"object"===
typeof b&&b?("shape"in b?(l=b.shape,d(Array.isArray(l)&&2<=l.length,"invalid renderbuffer shape"),m=l[0]|0,l=l[1]|0):("radius"in b&&(m=l=b.radius|0),"width"in b&&(m=b.width|0),"height"in b&&(l=b.height|0)),"format"in b&&(d.parameter(b.format,h,"invalid renderbuffer format"),p=h[b.format])):"number"===typeof b?(m=b|0,l="number"===typeof f?f|0:m):b?d.raise("invalid arguments to renderbuffer constructor"):m=l=1;d(0<m&&0<l&&m<=c.maxRenderbufferSize&&l<=c.maxRenderbufferSize,"invalid renderbuffer size");
if(m!==k.width||l!==k.height||p!==k.format)return r.width=k.width=m,r.height=k.height=l,k.format=p,a.bindRenderbuffer(36161,k.renderbuffer),a.renderbufferStorage(36161,p,m,l),e.profile&&(k.stats.size=X[k.format]*k.width*k.height),r.format=g[k.format],r}var k=new l(a.createRenderbuffer());p[k.id]=k;f.renderbufferCount++;r(b,t);r.resize=function(b,g){var f=b|0,h=g|0||f;if(f===k.width&&h===k.height)return r;d(0<f&&0<h&&f<=c.maxRenderbufferSize&&h<=c.maxRenderbufferSize,"invalid renderbuffer size");r.width=
k.width=f;r.height=k.height=h;a.bindRenderbuffer(36161,k.renderbuffer);a.renderbufferStorage(36161,k.format,f,h);e.profile&&(k.stats.size=X[k.format]*k.width*k.height);return r};r._reglType="renderbuffer";r._renderbuffer=k;e.profile&&(r.stats=k.stats);r.destroy=function(){k.decRef()};return r},clear:function(){aa(p).forEach(t)},restore:function(){aa(p).forEach(function(b){b.renderbuffer=a.createRenderbuffer();a.bindRenderbuffer(36161,b.renderbuffer);a.renderbufferStorage(36161,b.format,b.width,b.height)});
a.bindRenderbuffer(36161,null)}}},Zb=[6408],Eb=[];Eb[6408]=4;var cb=[];cb[5121]=1;cb[5126]=4;cb[36193]=2;var $b=[32854,32855,36194,35907,34842,34843,34836],Yb={36053:"complete",36054:"incomplete attachment",36057:"incomplete dimensions",36055:"incomplete, missing attachment",36061:"unsupported"},Pa=["x","y","z","w"],fc="blend.func blend.equation stencil.func stencil.opFront stencil.opBack sample.coverage viewport scissor.box polygonOffset.offset".split(" "),ua={0:0,1:1,zero:0,one:1,"src color":768,
"one minus src color":769,"src alpha":770,"one minus src alpha":771,"dst color":774,"one minus dst color":775,"dst alpha":772,"one minus dst alpha":773,"constant color":32769,"one minus constant color":32770,"constant alpha":32771,"one minus constant alpha":32772,"src alpha saturate":776},Hb="constant color, constant alpha;one minus constant color, constant alpha;constant color, one minus constant alpha;one minus constant color, one minus constant alpha;constant alpha, constant color;constant alpha, one minus constant color;one minus constant alpha, constant color;one minus constant alpha, one minus constant color".split(";"),
Oa={never:512,less:513,"<":513,equal:514,"=":514,"==":514,"===":514,lequal:515,"<=":515,greater:516,">":516,notequal:517,"!=":517,"!==":517,gequal:518,">=":518,always:519},Da={0:0,zero:0,keep:7680,replace:7681,increment:7682,decrement:7683,"increment wrap":34055,"decrement wrap":34056,invert:5386},Ib={frag:35632,vert:35633},nb={cw:2304,ccw:2305},Jb=new pa(!1,!1,!1,function(){}),ic=function(a,b){function c(){this.endQueryIndex=this.startQueryIndex=-1;this.sum=0;this.stats=null}function d(a,b,e){var f=
h.pop()||new c;f.startQueryIndex=a;f.endQueryIndex=b;f.sum=0;f.stats=e;g.push(f)}var e=b.ext_disjoint_timer_query;if(!e)return null;var f=[],l=[],h=[],g=[],r=[],p=[];return{beginQuery:function(a){var b=f.pop()||e.createQueryEXT();e.beginQueryEXT(35007,b);l.push(b);d(l.length-1,l.length,a)},endQuery:function(){e.endQueryEXT(35007)},pushScopeStats:d,update:function(){var a,b;a=l.length;if(0!==a){p.length=Math.max(p.length,a+1);r.length=Math.max(r.length,a+1);r[0]=0;var c=p[0]=0;for(b=a=0;b<l.length;++b){var d=
l[b];e.getQueryObjectEXT(d,34919)?(c+=e.getQueryObjectEXT(d,34918),f.push(d)):l[a++]=d;r[b+1]=c;p[b+1]=a}l.length=a;for(b=a=0;b<g.length;++b){var c=g[b],m=c.startQueryIndex,d=c.endQueryIndex;c.sum+=r[d]-r[m];m=p[m];d=p[d];d===m?(c.stats.gpuTime+=c.sum/1E6,h.push(c)):(c.startQueryIndex=m,c.endQueryIndex=d,g[a++]=c)}g.length=a}},getNumPendingQueries:function(){return l.length},clear:function(){f.push.apply(f,l);for(var a=0;a<f.length;a++)e.deleteQueryEXT(f[a]);l.length=0;f.length=0},restore:function(){l.length=
0;f.length=0}}};return function(a){function b(){if(0===T.length)D&&D.update(),X=null;else{X=ob.next(b);p();for(var a=T.length-1;0<=a;--a){var c=T[a];c&&c(F,null,0)}v.flush();D&&D.update()}}function c(){!X&&0<T.length&&(X=ob.next(b))}function f(){X&&(ob.cancel(b),X=null)}function e(a){a.preventDefault();A=!0;f();Y.forEach(function(a){a()})}function l(a){v.getError();A=!1;y.restore();P.restore();fa.restore();N.restore();O.restore();L.restore();D&&D.restore();M.procs.refresh();c();Z.forEach(function(a){a()})}
function t(a){function b(a){var c={},d={};Object.keys(a).forEach(function(b){var e=a[b];sa.isDynamic(e)?d[b]=sa.unbox(e,b):c[b]=e});return{dynamic:d,"static":c}}function c(a){for(;p.length<a;)p.push(null);return p}d(!!a,"invalid args to regl({...})");d.type(a,"object","invalid args to regl({...})");var e=b(a.context||{}),g=b(a.uniforms||{}),f=b(a.attributes||{}),h=b(function(a){function b(a){if(a in c){var d=c[a];delete c[a];Object.keys(d).forEach(function(b){c[a+"."+b]=d[b]})}}var c=V({},a);delete c.uniforms;
delete c.attributes;delete c.context;"stencil"in c&&c.stencil.op&&(c.stencil.opBack=c.stencil.opFront=c.stencil.op,delete c.stencil.op);b("blend");b("depth");b("cull");b("stencil");b("polygonOffset");b("scissor");b("sample");return c}(a));a={gpuTime:0,cpuTime:0,count:0};var e=M.compile(h,f,g,e,a),k=e.draw,l=e.batch,m=e.scope,p=[];return V(function(a,b){var e;A&&d.raise("context lost");if("function"===typeof a)return m.call(this,null,a,0);if("function"===typeof b)if("number"===typeof a)for(e=0;e<a;++e)m.call(this,
null,b,e);else if(Array.isArray(a))for(e=0;e<a.length;++e)m.call(this,a[e],b,e);else return m.call(this,a,b,0);else if("number"===typeof a){if(0<a)return l.call(this,c(a|0),a|0)}else if(Array.isArray(a)){if(a.length)return l.call(this,a,a.length)}else return k.call(this,a)},{stats:a})}function h(a,b){var c=0;M.procs.poll();var e=b.color;e&&(v.clearColor(+e[0]||0,+e[1]||0,+e[2]||0,+e[3]||0),c|=16384);"depth"in b&&(v.clearDepth(+b.depth),c|=256);"stencil"in b&&(v.clearStencil(b.stencil|0),c|=1024);
d(!!c,"called regl.clear with no buffer specified");v.clear(c)}function g(a){d.type(a,"function","regl.frame() callback must be a function");T.push(a);c();return{cancel:function(){function b(){var a=Kb(T,b);T[a]=T[T.length-1];--T.length;0>=T.length&&f()}var c=Kb(T,a);d(0<=c,"cannot cancel a frame twice");T[c]=b}}}function r(){var a=W.viewport,b=W.scissor_box;a[0]=a[1]=b[0]=b[1]=0;F.viewportWidth=F.framebufferWidth=F.drawingBufferWidth=a[2]=b[2]=v.drawingBufferWidth;F.viewportHeight=F.framebufferHeight=
F.drawingBufferHeight=a[3]=b[3]=v.drawingBufferHeight}function p(){F.tick+=1;F.time=x();r();M.procs.poll()}function u(){r();M.procs.refresh();D&&D.update()}function x(){return(Mb()-I)/1E3}a=gb(a);if(!a)return null;var v=a.gl,k=v.getContextAttributes(),A=v.isContextLost(),y=Qb(v,a);if(!y)return null;var C=fb(),B={bufferCount:0,elementsCount:0,framebufferCount:0,shaderCount:0,textureCount:0,cubeCount:0,renderbufferCount:0,maxTextureUnits:0},z=y.extensions,D=ic(v,z),I=Mb(),G=v.drawingBufferWidth,E=v.drawingBufferHeight,
F={tick:0,time:0,viewportWidth:G,viewportHeight:E,framebufferWidth:G,framebufferHeight:E,drawingBufferWidth:G,drawingBufferHeight:E,pixelRatio:a.pixelRatio},J=gc(v,z),fa=Rb(v,B,a),U=Sb(v,z,fa,B),G=ac(v,z,J,fa,C),P=bc(v,C,B,a),N=Vb(v,z,J,function(){M.procs.poll()},F,B,a),O=hc(v,z,J,B,a),L=Xb(v,z,J,N,O,B),M=ec(v,C,z,J,fa,U,N,L,{},G,P,{elements:null,primitive:4,count:-1,offset:0,instances:-1},F,D,a),C=cc(v,L,M.procs.poll,F,k,z),W=M.next,S=v.canvas,T=[],Y=[],Z=[],aa=[a.onDestroy],X=null;S&&(S.addEventListener("webglcontextlost",
e,!1),S.addEventListener("webglcontextrestored",l,!1));var ea=L.setFBO=t({framebuffer:sa.define.call(null,1,"framebuffer")});u();k=V(t,{clear:function(a){d("object"===typeof a&&a,"regl.clear() takes an object as input");if("framebuffer"in a)if(a.framebuffer&&"framebufferCube"===a.framebuffer_reglType)for(var b=0;6>b;++b)ea(V({framebuffer:a.framebuffer.faces[b]},a),h);else ea(a,h);else h(null,a)},prop:sa.define.bind(null,1),context:sa.define.bind(null,2),"this":sa.define.bind(null,3),draw:t({}),buffer:function(a){return fa.create(a,
34962,!1,!1)},elements:function(a){return U.create(a,!1)},texture:N.create2D,cube:N.createCube,renderbuffer:O.create,framebuffer:L.create,framebufferCube:L.createCube,attributes:k,frame:g,on:function(a,b){d.type(b,"function","listener callback must be a function");var c;switch(a){case "frame":return g(b);case "lost":c=Y;break;case "restore":c=Z;break;case "destroy":c=aa;break;default:d.raise("invalid event, must be one of frame,lost,restore,destroy")}c.push(b);return{cancel:function(){for(var a=0;a<
c.length;++a)if(c[a]===b){c[a]=c[c.length-1];c.pop();break}}}},limits:J,hasExtension:function(a){return 0<=J.extensions.indexOf(a.toLowerCase())},read:C,destroy:function(){T.length=0;f();S&&(S.removeEventListener("webglcontextlost",e),S.removeEventListener("webglcontextrestored",l));P.clear();L.clear();O.clear();N.clear();U.clear();fa.clear();D&&D.clear();aa.forEach(function(a){a()})},_gl:v,_refresh:u,poll:function(){p();D&&D.update()},now:x,stats:B});a.onDone(null,k);return k}})},{}],11:[function(B,
u,z){function f(f,u){var y=l(getComputedStyle(f).getPropertyValue(u));return y[0]*c(y[1],f)}function c(c,l){l=l||document.body;c=(c||"px").trim().toLowerCase();if(l===window||l===document)l=document.body;switch(c){case "%":return l.clientHeight/100;case "ch":case "ex":var u=c,D=l,z=document.createElement("div");z.style["font-size"]="128"+u;D.appendChild(z);u=f(z,"font-size")/128;D.removeChild(z);return u;case "em":return f(l,"font-size");case "rem":return f(document.body,"font-size");case "vw":return window.innerWidth/
100;case "vh":return window.innerHeight/100;case "vmin":return Math.min(window.innerWidth,window.innerHeight)/100;case "vmax":return Math.max(window.innerWidth,window.innerHeight)/100;case "in":return E;case "cm":return E/2.54;case "mm":return E/25.4;case "pt":return E/72;case "pc":return E/6}return 1}var l=B("parse-unit");u.exports=c;var E=96},{"parse-unit":9}],12:[function(B,u,z){var f=B("regl")();u=B("bunny");z=B("angle-normals");var c=B("./util/camera")(f,{center:[0,2.5,0]}),l=f({frag:"\n    precision mediump float;\n    varying vec3 vnormal;\n    void main () {\n      gl_FragColor = vec4(abs(vnormal), 1.0);\n    }",
vert:"\n    precision mediump float;\n    uniform mat4 projection, view;\n    attribute vec3 position, normal;\n    varying vec3 vnormal;\n    void main () {\n      vnormal = normal;\n      gl_Position = projection * view * vec4(position, 1.0);\n    }",attributes:{position:u.positions,normal:z(u.cells,u.positions)},elements:u.cells});f.frame(function(){f.clear({color:[0,0,0,1]});c(function(){l()})})},{"./util/camera":13,"angle-normals":1,bunny:2,regl:10}],13:[function(B,u,z){var f=B("mouse-change"),
c=B("mouse-wheel"),l=B("gl-mat4/identity"),E=B("gl-mat4/perspective"),t=B("gl-mat4/lookAt");u.exports=function(u,y){function z(c){c*=.9;return.1>c?0:c}function B(c){var f=x.center,l=x.eye,u=x.up;x.theta+=G;x.phi=Math.min(Math.max(x.phi+I,-Math.PI/2),Math.PI/2);x.distance=Math.min(Math.max(x.distance+Z,C),eb);G=z(G);I=z(I);Z=z(Z);for(var y=x.theta,A=x.phi,E=Math.exp(x.distance),O=E*Math.sin(y)*Math.cos(A),y=E*Math.cos(y)*Math.cos(A),A=E*Math.sin(A),E=0;3>E;++E)l[E]=f[E]+O*F[E]+y*J[E]+A*u[E];t(x.view,
l,f,u);L(c)}var x={view:l(new Float32Array(16)),projection:l(new Float32Array(16)),center:new Float32Array(y.center||3),theta:y.theta||0,phi:y.phi||0,distance:Math.log(y.distance||10),eye:new Float32Array(3),up:new Float32Array(y.up||[0,1,0])},J=new Float32Array([1,0,0]),F=new Float32Array([0,0,1]),C=Math.log("minDistance"in y?y.minDistance:.1),eb=Math.log("maxDistance"in y?y.maxDistance:1E3),G=0,I=0,Z=0,ja=0,O=0;f(function(c,f,l){if(c&1){c=(l-O)/window.innerHeight;var t=Math.max(x.distance,.5);G+=
(f-ja)/window.innerWidth*t;I+=t*c}ja=f;O=l});c(function(c,f){Z+=f/window.innerHeight});var L=u({context:Object.assign({},x,{projection:function(c){return E(x.projection,Math.PI/4,c.viewportWidth/c.viewportHeight,.01,1E3)}}),uniforms:Object.keys(x).reduce(function(c,f){c[f]=u.context(f);return c},{})});Object.keys(x).forEach(function(c){B[c]=x[c]});return B}},{"gl-mat4/identity":3,"gl-mat4/lookAt":4,"gl-mat4/perspective":5,"mouse-change":6,"mouse-wheel":8}]},{},[12]);
